  ...
  [33],
  {
      ...
      let s = (() => {
        ...
        return (
          ...
          (e.ɵcmp = i.Mb({
            ...
            features: [i.Cb([{ provide: o.c, useExisting: Object(i.V)(() => e) }]), i.Ab],
            attrs: a,
            decls: 0,
            vars: 0,
      ...
      let h = (() => {
        ...
        return (
          ...
          (e.ɵinj = u.Pb({
            ...
            providers: [],
            imports: [[i.c, o.f, s.b, c.e, a.f, l.a, r.a, m.a]],
          })),
          e
        );
      })();
    ...
    yWiE: function(e, t, n) {
      ...
      var i = n('ofXK'),
        ...
        x = n('FKr1');
      function D(e, t) {
        if ((1 & e && (d.Yb(0, 'mat-option', 11), d.Tc(1), d.Wb()), 2 & e)) {
          const e = t.$implicit;
          d.qc('value', e), d.Db(1), d.Vc('\n        ', e, '\n      ');
        }
      }
      function I(e, t) {
        if (
          ...
          const e = d.kc().$implicit;
          d.Db(11),
            d.Vc('\n              ', e.seriesName + ': ' + e.value[1], '\n            '),
            d.Db(4),
            d.Vc('at ', d.nc(16, 2, e.name, 'medium'), '');
        }
      }
      function k(e, t) {
        if ((1 & e && (d.Tc(0, '\n        '), d.Rc(1, I, 18, 5, 'ng-container', 12), d.Tc(2, '\n      ')), 2 & e)) {
          const e = t.$implicit;
          d.Db(1), d.qc('ngIf', e);
        }
      }
      ...
      function A(e, t) {
        if ((1 & e && (d.Tc(0, '\n        '), d.Rc(1, O, 18, 5, 'ng-container', 12), d.Tc(2, '\n      ')), 2 & e)) {
          const e = t.$implicit;
          d.Db(1), d.qc('ngIf', e);
        }
      }
      ...
      let V = (() => {
        ...
        return (
          (e.ɵfac = function(t) {
            return new (t || e)(d.Sb(d.h), d.Sb(y.a));
          }),
          (e.ɵcmp = d.Mb({
            type: e,
            ...
            template: function(e, t) {
              1 & e &&
                ...
                d.lc(15, 'async'),
                d.Tc(16, '\n  '),
                d.Tb(17, 'td-chart-tooltip', 6),
                d.Tc(18, '\n  '),
                d.Tb(19, 'td-chart-x-axis', 7),
                d.Tc(20, '\n  '),
                d.Tb(21, 'td-chart-y-axis', 8),
                d.Tc(22, '\n  '),
                d.Yb(23, 'td-chart-series', 9),
                d.Tc(24, '\n    '),
                d.Yb(25, 'td-chart-series-tooltip'),
                d.Tc(26, '\n      '),
                d.Rc(27, k, 3, 1, 'ng-template', 10),
                d.Tc(28, '\n    '),
                d.Wb(),
                d.Tc(29, '\n  '),
                d.Wb(),
                d.Tc(30, '\n  '),
                d.Yb(31, 'td-chart-series', 9),
                d.Tc(32, '\n    '),
                d.Yb(33, 'td-chart-series-tooltip'),
                d.Tc(34, '\n      '),
                d.Rc(35, A, 3, 1, 'ng-template', 10),
                d.Tc(36, '\n    '),
                d.Wb(),
                d.Tc(37, '\n  '),
                d.Wb(),
                ...
                2 & e &&
                  ...
                  d.Db(5),
                  d.Pc('height', 300, 'px'),
                  d.qc('themeName', d.mc(15, 20, t.themeSelector.selected$)),
                  d.Db(3),
                  d.qc('trigger', 'item'),
                  d.Db(2),
                  d.qc('show', !0)('position', 'top')('type', 'time')('splitLine', d.uc(22, W))('boundaryGap', !1),
                  d.Db(2),
                  d.qc('show', !0)('type', 'value'),
                  d.Db(2),
                  d.qc('symbolSize', 14)(
                    'data',
                    d.xc(32, R, d.vc(24, Y, d.uc(23, L)), d.vc(27, Z, d.uc(26, N)), d.vc(30, C, d.uc(29, z))),
                  )('name', 'Revenue')('symbol', 'roundRect'),
                  d.Db(8),
                  d.qc('symbolSize', 14)(
                    'data',
                    d.xc(45, R, d.vc(37, M, d.uc(36, E)), d.vc(40, K, d.uc(39, q)), d.vc(43, U, d.uc(42, P))),
                  )('name', 'Sales')('symbol', 'roundRect'));
            },
            directives: [p.b, a.a, i.s, f.a, T.a, v.a, S.a, g.a, w.a, T.b, x.k, i.t, s.a],
            pipes: [i.b, i.f],
      ...
      const F = Object(u.c)({ overviewDemoComponent: V, id: 'line' });
      let j = (() => {
        class e {}
        return (
          (e.ɵmod = d.Qb({ type: e })),
          (e.ɵinj = d.Pb({
            ...
            providers: [],
            imports: [[i.c, a.b, s.b, r.a, l.a, m.a, c.a, h.a, o.f.forChild(F)]],
          })),
          e
        );
      })();
