  ...
  [28],
  {
    '7hwW': function(t, e, n) {
      ...
      const _ = function() {
        ...
        L = function(t, e, n, r, i, o, a, s, c, u, l, h, m, d, f, p, b, g, y) {
          return [t, e, n, r, i, o, a, s, c, u, l, h, m, d, f, p, b, g, y];
        },
        V = function() {
      ...
      let ct = (() => {
        ...
        return (
          (t.ɵfac = function(e) {
            return new (e || t)(h.Sb(h.h), h.Sb(m.a));
          }),
          (t.ɵcmp = h.Mb({
            type: t,
            ...
            directives: [d.b, i.a, r.s, f.a, p.a, p.b, b.a, g.a, y.a, v.k, r.t, o.a],
            pipes: [r.b],
            styles: [''],
            changeDetection: 0,
          })),
      ...
      let pt = (() => {
        ...
        return (
          ...
          (t.ɵinj = h.Pb({
            ...
            imports: [[ft.a, dt, a.a, s.a, c.a, u.a, r.c, i.b, o.b]],
          })),
          t
        );
      })();
    ...
    'BGHn': function(t, e, n) {
      ...
      let c = (() => {
          ...
          return (
            ...
            (t.ɵdir = r.Nb({ type: t, selectors: [['ng-template', 'tdViewDataFormatter', '']] })),
            t
          );
        })(),
        u = (() => {
          ...
          return (
            (t.ɵfac = function(e) {
              return new (e || t)(r.Sb(r.h), r.Sb(r.k), r.Sb(i.b));
            }),
            (t.ɵcmp = r.Mb({
              type: t,
              ...
              contentQueries: function(t, e, n) {
                var i;
                1 & t && r.Kb(n, c, !0, r.M), 2 & t && r.Ec((i = r.hc())) && (e.formatterTemplate = i.first);
              },
              viewQuery: function(t, e) {
                var n;
                1 & t && r.Nc(a, !0), 2 & t && r.Ec((n = r.hc())) && (e.fullTemplate = n.first);
              },
              inputs: {
                config: 'config',
                show: 'show',
              ...
              template: function(t, e) {
                1 & t && r.Rc(0, s, 0, 0, 'ng-template', 0, 1, r.Sc),
                  2 & t && r.qc('ngTemplateOutlet', e.formatterTemplate);
              },
              directives: [o.A],
              encapsulation: 2,
              changeDetection: 0,
    ...
    'Fa/5': function(t, e, n) {
      ...
      var i = n('f5Yq'),
        o = n('h8O9');
      n('Ae16'), r.registerVisual(i('scatter', 'circle')), r.registerLayout(o('scatter'));
    },
    'NEPT': function(t, e, n) {
      'use strict';
      var r = n('ofXK'),
      ...
      r.extendChartView({
        ...
        updateTransform: function(t, e, n) {
          ...
          if ((this.group.dirty(), !this._finished || r.count() > 1e4 || !this._symbolDraw.isPersistent()))
            return { update: !0 };
          var i = a().reset(t);
          i.progress && i.progress({ start: 0, end: r.count() }, r), this._symbolDraw.updateLayout(r);
        },
        _updateSymbolDraw: function(t, e) {
          ...
          return (
            (n && r === this._isLargeDraw) ||
              (n && n.remove(),
              (n = this._symbolDraw = r ? new o() : new i()),
              (this._isLargeDraw = r),
          ...
          afterBrush: function(t) {
            ...
            if (r[0] < 4) {
              ...
              for (var i = 0; i < n.length; ) {
                var o = n[i++],
                  a = n[i++];
                isNaN(o) || isNaN(a) || t.fillRect(o - r[0] / 2, a - r[1] / 2, r[0], r[1]);
              }
      ...
      (c.isPersistent = function() {
        ...
        (c._setCommon = function(t, e, n) {
          ...
          t.setShape('size', o instanceof Array ? o : [o, o]),
            (t.symbolProxy = i(e.getVisual('symbol'), 0, 0, 0, 0)),
