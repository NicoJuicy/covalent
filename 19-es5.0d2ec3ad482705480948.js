      ...
      t.exports = function(t, e, n, l, c) {
        ...
        for (f = 0; f < e.length; f++) {
          var v = e[f],
            m = v.source,
            _ = v.target;
          h.addEdge(m, _, y) && (g.push(v), p.push(i.retrieve(v.id, m + ' > ' + _)), y++);
        }
        var b,
          I = n.get('coordinateSystem');
        if ('cartesian2d' === I || 'polar' === I) b = d(t, n);
        else {
          var x = u.get(I),
            w = (x && 'view' !== x.type && x.dimensions) || [];
          i.indexOf(w, 'value') < 0 && w.concat(['value']);
          var M = s(t, { coordDimensions: w });
          (b = new a(M, n)).initData(t);
        }
        var V = new a(['value'], n);
        return (
          V.initData(g, p),
      ...
      var i = n('fXoL'),
        ...
        r = (function() {
          var t = (function(t) {
            function e(t) {
              return (
                _classCallCheck(this, e), _possibleConstructorReturn(this, _getPrototypeOf(e).call(this, 'sankey', t))
              );
            }
            return (
              _inherits(e, t),
    ...
    'XxSj': function(t, e, n) {
      var i = n('bYtY'),
        ...
        d = function(t) {
          ...
          (this.type = n), (this.mappingMethod = e), (this._normalizeData = b[e]);
          var o = l[n];
      ...
      var l = (d.visualHandlers = {
        ...
        opacity: { applyVisual: p('opacity'), _doMap: v([0, 1]) },
        liftZ: { applyVisual: p('liftZ'), _doMap: { linear: y, category: y, piecewise: y, fixed: y } },
        symbol: {
        ...
        symbolSize: { applyVisual: p('symbolSize'), _doMap: v([0, 1]) },
      });
      function c(t, e) {
        var n = t.visual,
          a = [];
      ...
      (d.listVisualTypes = function() {
        ...
        (d.findPieceIndex = function(t, e, n) {
          ...
          for (o = 0, r = e.length; o < r; o++) {
            ...
            if (d) {
              if (d[0] === -1 / 0) {
                if (I(l[1], t, d[1])) return o;
              } else if (d[1] === 1 / 0) {
                if (I(l[0], d[0], t)) return o;
              } else if (I(l[0], d[0], t) && I(l[1], t, d[1])) return o;
              n && c(d[0], o), n && c(d[1], o);
            }
          }
