  ...
  [39],
  {
    BGHn: function(e, t, n) {
      ...
      let s = (() => {
          ...
          return (
            ...
            (e.ɵdir = c.Nb({ type: e, selectors: [['ng-template', 'tdViewDataFormatter', '']] })),
            e
          );
        })(),
        r = (() => {
          ...
          return (
            (e.ɵfac = function(t) {
              return new (t || e)(c.Sb(c.h), c.Sb(c.k), c.Sb(o.b));
            }),
            (e.ɵcmp = c.Mb({
              type: e,
              ...
              contentQueries: function(e, t, n) {
                var o;
                1 & e && c.Kb(n, s, !0, c.M), 2 & e && c.Ec((o = c.hc())) && (t.formatterTemplate = o.first);
              },
              viewQuery: function(e, t) {
                var n;
                1 & e && c.Nc(u, !0), 2 & e && c.Ec((n = c.hc())) && (t.fullTemplate = n.first);
              },
              inputs: {
                config: 'config',
                show: 'show',
              ...
              template: function(e, t) {
                1 & e && c.Rc(0, a, 0, 0, 'ng-template', 0, 1, c.Sc),
                  2 & e && c.qc('ngTemplateOutlet', t.formatterTemplate);
              },
              directives: [i.A],
              encapsulation: 2,
              changeDetection: 0,
    ...
    Q2R2: function(e, t, n) {
      ...
      var c = n('ofXK'),
        ...
        f = n('FKr1');
      function A(e, t) {
        if ((1 & e && (h.Yb(0, 'mat-option', 9), h.Tc(1), h.Wb()), 2 & e)) {
          const e = t.$implicit;
          h.qc('value', e), h.Db(1), h.Vc('\n        ', e, '\n      ');
        }
      }
      function v(e, t) {
        if (
      ...
      const T = function() {
        ...
        oe = function(e, t) {
          return { colorSaturation: e, itemStyle: t };
        };
      let ie = (() => {
        class e {
          constructor(e, t) {
                ...
                },
                {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      path: 'AddressBook Plug-Ins/LocalSource.sourcebundle',
                      children: [
                        { value: 20, name: 'Contents', path: 'AddressBook Plug-Ins/LocalSource.sourcebundle/Contents' },
                      ],
                    },
                  ],
                },
        ...
        return (
          (e.ɵfac = function(t) {
            return new (t || e)(h.Sb(h.h), h.Sb(d.a));
          }),
          (e.ɵcmp = h.Mb({
            type: e,
            ...
            template: function(e, t) {
              1 & e &&
                ...
                h.Tc(18, '\n    '),
                h.Rc(19, P, 3, 1, 'ng-template', 7),
                h.Tc(20, '\n  '),
                h.Wb(),
                h.Tc(21, '\n  '),
                h.Tb(22, 'td-chart-series', 8),
                h.Tc(23, '\n'),
                h.Wb(),
                h.Tc(24, '\n')),
                2 & e &&
                  ...
                  h.Db(5),
                  h.Pc('height', 600, 'px'),
                  h.qc('themeName', h.mc(15, 14, t.themeSelector.selected$)),
                  h.Db(3),
                  h.qc('trigger', 'item'),
                  h.Db(5),
                  h.qc('top', '10%')('left', '10%')('bottom', '10%')('right', '10%')(
                    'data',
                    h.xc(
                      85,
                      V,
                      ...
                      h.vc(
                        ...
                        h.xc(
                          46,
                          V,
                          h.vc(26, y, h.yc(21, w, h.uc(17, k), h.uc(18, S), h.uc(19, D), h.uc(20, C))),
                          h.vc(39, x, h.zc(33, O, h.uc(28, I), h.uc(29, W), h.uc(30, B), h.uc(31, L), h.uc(32, F))),
                          h.vc(44, z, h.vc(42, _, h.uc(41, N))),
                        ),
                      ),
                      h.vc(
                        83,
                        ...
                        h.zc(
                          77,
                          O,
                          h.vc(55, Y, h.vc(53, _, h.uc(52, M))),
                          h.vc(60, R, h.vc(58, _, h.uc(57, j))),
                          h.vc(65, G, h.vc(63, _, h.uc(62, q))),
                          h.vc(70, X, h.vc(68, _, h.uc(67, Q))),
                          h.vc(75, H, h.vc(73, _, h.uc(72, K))),
                        ),
                      ),
                    ),
                  )('visibleMin', 300)('label', h.uc(89, J))('leafDepth', 2)(
                    'levels',
                    h.xc(
                      107,
                      V,
                      h.vc(93, ee, h.vc(91, Z, h.uc(90, U))),
                      h.vc(98, ee, h.vc(96, Z, h.uc(95, te))),
                      h.wc(104, oe, h.uc(100, ne), h.vc(102, Z, h.uc(101, ce))),
                    ),
                  ));
            },
            directives: [b.b, o.a, c.s, m.a, p.a, p.b, g.a, f.k, c.t, i.a],
            pipes: [c.b],
            styles: [''],
            changeDetection: 0,
          })),
      ...
      let ae = (() => {
        ...
        return (
          ...
          (e.ɵcmp = h.Mb({
            ...
            consts: [[3, 'demoId']],
            template: function(e, t) {
              1 & e && (h.Yb(0, 'demo-component', 0), h.Tb(1, 'treemap-demo-basic'), h.Wb()),
                2 & e && h.qc('demoId', 'treemap-demo-basic');
            },
            directives: [ue.a, ie],
            styles: [''],
          })),
      ...
      let le = (() => {
        ...
        return (
          ...
          (e.ɵinj = h.Pb({
            ...
            imports: [[se.f.forChild(re)], se.f],
          })),
          e
        );
      })();
      var he = n('Krbs');
      n.d(t, 'TreemapDemoModule', function() {
        return de;
      });
      let de = (() => {
        class e {}
        return (
          ...
          (e.ɵinj = h.Pb({
            ...
            imports: [[he.a, le, u.a, a.a, s.a, r.a, c.c, o.b, i.b]],
          })),
          e
        );
      })();
