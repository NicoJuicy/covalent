...
!(function(e) {
  ...
  var i = (function() {
    ...
    return (
      ...
      (e.prototype.advanceIfChars = function(e) {
        ...
        for (var t = 0; t < e.length; t++) if (this.source.charCodeAt(this.position + t) !== e[t]) return !1;
  ...
  var H = (function() {
    function e() {
      (this.stream = new i('')), (this.ignoreComment = !0), (this.ignoreWhitespace = !0), (this.inURL = !1);
    }
    return (
      ...
      (e.prototype.scanNext = function(e) {
        ...
        if (this.stream.advanceIfChar(C)) {
          if (((t = ['@']), this._name(t))) {
            var n = t.join('');
            return '@charset' === n ? this.finishToken(e, a.Charset, n) : this.finishToken(e, a.AtKeyword, n);
          }
          return this.finishToken(e, a.Delim);
        }
        if (this.stream.advanceIfChar(F))
          return (t = ['#']), this._name(t) ? this.finishToken(e, a.Hash, t.join('')) : this.finishToken(e, a.Delim);
        ...
        if (this._number()) {
          ...
          if (this.ident(t)) {
            var r = this.stream.substring(i).toLowerCase(),
              o = G[r];
            return void 0 !== o ? this.finishToken(e, o, t.join('')) : this.finishToken(e, a.Dimension, t.join(''));
          }
      ...
      (e.prototype._escape = function(e, t) {
        ...
        if (n === I) {
          ...
          for (var i = 0; i < 6 && ((p <= n && n <= h) || (o <= n && n <= s) || (l <= n && n <= c)); )
          ...
          if (n !== A && n !== D && n !== _) return this.stream.advance(1), e.push(String.fromCharCode(n)), !0;
...
!(function(e) {
  ...
  Object.defineProperty(t, '__esModule', { value: !0 }),
    ...
    (n[(n.SelectorCombinatorShadowPiercingDescendant = 11)] = 'SelectorCombinatorShadowPiercingDescendant'),
    (n[(n.Page = 12)] = 'Page'),
  ...
  (function(e) {
    ...
    (t.CSSIssueType = i),
      (t.ParseError = {
        ...
        ConditionExpected: new i('css-conditionexpected', n('expected.condt', 'condition expected')),
        ...
        SemiColonExpected: new i('css-semicolonexpected', n('expected.semicolon', 'semi-colon expected')),
        TermExpected: new i('css-termexpected', n('expected.term', 'term expected')),
        ExpressionExpected: new i('css-expressionexpected', n('expected.expression', 'expression expected')),
        OperatorExpected: new i('css-operatorexpected', n('expected.operator', 'operator expected')),
        IdentifierExpected: new i('css-identifierexpected', n('expected.ident', 'identifier expected')),
        PercentageExpected: new i('css-percentageexpected', n('expected.percentage', 'percentage expected')),
        URIOrStringExpected: new i('css-uriorstringexpected', n('expected.uriorstring', 'uri or string expected')),
        URIExpected: new i('css-uriexpected', n('expected.uri', 'URI expected')),
        VariableNameExpected: new i('css-varnameexpected', n('expected.varname', 'variable name expected')),
        VariableValueExpected: new i('css-varvalueexpected', n('expected.varvalue', 'variable value expected')),
        PropertyValueExpected: new i('css-propertyvalueexpected', n('expected.propvalue', 'property value expected')),
        ...
        LeftSquareBracketExpected: new i('css-rbracketexpected', n('expected.lsquare', '[ expected')),
        RightSquareBracketExpected: new i('css-lbracketexpected', n('expected.rsquare', '] expected')),
        ...
        SelectorExpected: new i('css-selectorexpected', n('expected.selector', 'selector expected')),
        StringLiteralExpected: new i(
          'css-stringliteralexpected',
          n('expected.stringliteral', 'string literal expected'),
        ),
        WhitespaceExpected: new i('css-whitespaceexpected', n('expected.whitespace', 'whitespace expected')),
        MediaQueryExpected: new i('css-mediaqueryexpected', n('expected.mediaquery', 'media query expected')),
      });
  }),
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      (t.cssData = {
        ...
        properties: [
          ...
          },
          {
            ...
            values: [{ name: 'fill', description: 'Causes the middle part of the border-image to be preserved.' }],
          ...
          { name: 'color', syntax: '<color>', description: "Color of an element's text", restrictions: ['color'] },
          {
            name: 'color-interpolation-filters',
            browsers: ['E', 'C5', 'FF3', 'IE10', 'O9', 'S6'],
            values: [
              { name: 'auto', description: 'Color operations are not required to occur in a particular color space.' },
              { name: 'linearRGB' },
              { name: 'sRGB' },
            ],
          ...
          },
          {
            ...
            values: [
              ...
              { name: 'normal', description: 'See http://www.w3.org/TR/css3-content/#content for computation rules.' },
              { name: 'url()' },
            ],
          ...
          },
          {
            ...
            values: [
              { name: 'alias' },
              { name: 'all-scroll' },
              { name: 'auto', description: 'The UA determines the cursor to display based on the current context.' },
              { name: 'cell' },
              { name: 'col-resize' },
              { name: 'context-menu' },
              { name: 'copy' },
              { name: 'crosshair' },
              { name: 'default', description: 'The platform-dependent default cursor. Often rendered as an arrow.' },
              { name: 'e-resize' },
              { name: 'ew-resize' },
              { name: 'grab' },
              { name: 'grabbing' },
          ...
          },
          {
            name: 'flex',
            values: [
              { name: 'auto', description: "Retrieves the value of the main size property as the used 'flex-basis'." },
              { name: 'content', description: 'Indicates automatic sizing, based on the flex item’s content.' },
          ...
          },
          {
            ...
            values: [
              ...
              { name: '"curs"' },
              { name: '"c2pc"' },
              { name: '"c2cs"', description: 'Small Capitals From Capitals. Applies only to bicameral scripts.' },
              { name: '"dist"' },
          ...
          },
          {
            ...
            values: [
              { name: 'auto', description: 'Specifies that kerning is applied at the discretion of the user agent.' },
          ...
          },
          {
            ...
            values: [
              ...
              { name: 'none', browsers: ['FF34', 'S9.1', 'C34', 'O21'], description: 'Disables all ligatures.' },
          ...
          },
          {
            ...
            values: [
              ...
              { name: 'super', description: 'Enables display of superscript variants (OpenType feature: sups).' },
            ],
          ...
          },
          {
            ...
            values: [
              ...
              { name: 'subgrid', description: 'Indicates that the grid will align to its parent grid in that axis.' },
              { name: 'minmax()' },
              {
                name: 'repeat()',
                description:
          ...
          },
          {
            ...
            browsers: ['FF53'],
            values: [
              { name: 'alpha', description: 'Alpha values of the mask layer image should be used as the mask values.' },
              {
                name: 'auto',
                description:
          ...
          },
          {
            ...
            values: [
              ...
              { name: 'luminance', description: 'Indicates that the luminance values of the mask should be used.' },
            ],
          ...
          },
          {
            ...
            values: [
              ...
              { name: 'stretch', description: 'The height of each child is adjusted to that of the containing block.' },
            ],
            description:
          ...
          },
          {
            ...
            values: [
              ...
              { name: 'none', description: 'Renderers must not do size adjustment when displaying on a small device.' },
            ],
          ...
          },
          {
            ...
            values: [
              ...
              { name: 'snapInterval(100%, 100%)', description: 'Specifies where the snap-points will be placed.' },
              {
                name: 'snapList()',
                description:
          ...
          },
          {
            ...
            values: [
              ...
              { name: 'left', description: 'The ruby text content is aligned with the start edge of the base.' },
          ...
          },
          {
            name: 'ruby-span',
            browsers: ['FF10'],
            values: [{ name: 'attr(x)' }, { name: 'none', description: "No spanning. The computed value is '1'." }],
            description:
              'Determines whether, and on which side, ruby text is allowed to partially overhang any adjacent text in addition to its own base, when the ruby text is wider than the ruby base.',
            restrictions: ['enum'],
          },
          ...
          },
          {
            ...
            browsers: ['FF39'],
            values: [{ name: 'none', description: 'Specifies that this element does not contribute a snap point.' }],
            status: 'obsolete',
          ...
          },
          {
            ...
            values: [
              ...
              { name: 'crispEdges' },
              { name: 'geometricPrecision', description: 'Emphasize geometric precision over speed and crisp edges.' },
              {
                name: 'optimizeSpeed',
          ...
          },
          {
            ...
            values: [
              { name: 'bevel' },
              { name: 'miter' },
              { name: 'round', description: 'Indicates that a round corner is to be used to join path segments.' },
            ],
            description:
          ...
          },
          {
            ...
            values: [
              { name: 'center', description: 'The inline contents are centered within the line box.' },
              { name: 'end', description: 'The inline contents are aligned to the end edge of the line box.' },
              {
                name: 'justify',
                description: "The text is justified according to the method specified by the 'text-justify' property.",
              },
              ...
              { name: 'start', description: 'The inline contents are aligned to the start edge of the line box.' },
            ],
          ...
          },
          {
            ...
            browsers: ['S7'],
            values: [
              { name: 'auto', description: 'Neither force nor forbid a page/column break inside the generated box.' },
          ...
          },
          {
            ...
            values: [
              ...
              { name: 'nowrap', description: "Sets 'white-space-collapsing' to 'collapse' and 'text-wrap' to 'none'." },
              { name: 'pre' },
              { name: 'pre-line' },
              { name: 'pre-wrap' },
            ],
        ...
        atDirectives: [
          ...
          { name: '@-webkit-keyframes', browsers: ['C', 'S4'], description: 'Defines set of animation key frames.' },
        ],
        pseudoClasses: [
          {
            name: ':active',
        ...
        pseudoElements: [
          ...
          { name: '::-ms-fill', browsers: ['E', 'IE10'], description: 'Represents the bar portion of a progress bar.' },
          {
            name: '::-ms-fill-lower',
            browsers: ['E', 'IE'],
            description:
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-css-languageservice/languageFacts/dataManager', ['require', 'exports', '../utils/objects'], e);
  })(function(e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 });
      ...
      i = (function() {
        ...
        return (
          ...
          (e.prototype.getPseudoClasses = function(e) {
            return void 0 === e && (e = !0), e ? this._pseudoClasses.filter(r) : this._pseudoClasses;
          }),
          (e.prototype.getPseudoElements = function(e) {
            return void 0 === e && (e = !0), e ? this._pseudoElements.filter(r) : this._pseudoElements;
          }),
          ...
          (e.prototype.isStandardProperty = function(e) {
            return (
              ...
              (!this._propertySet[e.toLowerCase()].status || 'standard' === this._propertySet[e.toLowerCase()].status)
            );
          }),
          e
        );
  ...
  (function(e) {
    ...
    Object.defineProperty(o, '__esModule', { value: !0 }),
      (o.browserNames = { E: 'Edge', FF: 'Firefox', S: 'Safari', C: 'Chrome', IE: 'IE', O: 'Opera' }),
  ...
  (function(e) {
    ...
    var i = 48,
      ...
      a = 102;
    function l(e) {
      return e < i ? 0 : e <= r ? e - i : (e < s && (e += s - o), s <= e && e <= a ? e - s + 10 : 0);
    }
    function h(e) {
      if ('#' !== e[0]) return null;
      switch (e.length) {
      ...
      (c.getColorValue = function(e) {
        ...
        if (e.type === d.NodeType.Function) {
          ...
          if (o.parent && o.parent.type === d.NodeType.BinaryExpression) {
            var s = o.parent;
            if (s.parent && s.parent.type === d.NodeType.ListEntry && s.parent.key === s) return null;
          }
      ...
      i = (function() {
        ...
        return (
          ...
          (e.prototype.finish = function(e, t, n, i) {
            if (!(e instanceof a.Nodelist) && (t && this.markError(e, t, n, i), null !== this.prevToken)) {
          ...
          (e.prototype.markError = function(e, t, n, i) {
            this.token !== this.lastErrorToken &&
              (e.addIssue(new a.Marker(e, t, a.Level.Error, null, this.token.offset, this.token.len)),
          ...
          (e.prototype.parseStylesheet = function(n) {
            ...
            return this.internalParse(n.getText(), this._parseStylesheet, function(e, t) {
              if (n.version !== i) throw new Error('Underlying model has changed, AST is no longer valid');
            ...
            do {
              ...
              do {
                ...
                for (
                  ...
                  this.accept(s.TokenType.SemiColon) || this.accept(s.TokenType.CDO) || this.accept(s.TokenType.CDC);
          ...
          (e.prototype._parseStylesheetStatement = function(e) {
            return (
              void 0 === e && (e = !1),
              this.peek(s.TokenType.AtKeyword) ? this._parseStylesheetAtStatement(e) : this._parseRuleset(e)
            );
          }),
          ...
          (e.prototype._tryParseRuleset = function(e) {
            ...
            if (this._parseSelector(e)) {
              ...
              if (this.accept(s.TokenType.CurlyL)) return this.restoreAtMark(t), this._parseRuleset(e);
            }
          ...
          (e.prototype._parseRuleset = function(e) {
            ...
            for (; this.accept(s.TokenType.Comma); )
              if (!n.addChild(this._parseSelector(e))) return this.finish(t, l.ParseError.SelectorExpected);
          ...
          (e.prototype._parseDeclarations = function(e) {
            ...
            for (var n = e(); t.addChild(n) && !this.peek(s.TokenType.CurlyR); ) {
              if (this._needsSemicolonAfter(n) && !this.accept(s.TokenType.SemiColon))
                return this.finish(t, l.ParseError.SemiColonExpected, [s.TokenType.SemiColon, s.TokenType.CurlyR]);
              for (; this.accept(s.TokenType.SemiColon); );
              n = e();
            }
            return this.accept(s.TokenType.CurlyR)
              ? this.finish(t)
              : this.finish(t, l.ParseError.RightCurlyExpected, [s.TokenType.CurlyR, s.TokenType.SemiColon]);
          }),
          (e.prototype._parseBody = function(e, t) {
            return e.setDeclarations(this._parseDeclarations(t))
              ? this.finish(e)
              : this.finish(e, l.ParseError.LeftCurlyExpected, [s.TokenType.CurlyR, s.TokenType.SemiColon]);
          }),
          ...
          (e.prototype._tryParseCustomPropertyDeclaration = function() {
            ...
            if (!this.accept(s.TokenType.Colon)) return this.finish(e, l.ParseError.ColonExpected, [s.TokenType.Colon]);
            ...
            if (this.peek(s.TokenType.CurlyL)) {
              ...
              if (
                ...
                return this.finish(n), e.setPropertySet(n), (e.semicolonPosition = this.token.offset), this.finish(e);
          ...
          (e.prototype._parseKeyframeSelector = function() {
            ...
            if (!e.addChild(this._parseIdent()) && !this.accept(s.TokenType.Percentage)) return null;
            for (; this.accept(s.TokenType.Comma); )
          ...
          (e.prototype._parseSupportsDeclaration = function(e) {
            return (
              void 0 === e && (e = !1),
              e
                ? this._tryParseRuleset(!0) || this._tryToParseDeclaration() || this._parseStylesheetStatement(!0)
          ...
          (e.prototype._parseSupportsCondition = function() {
            ...
            if (this.acceptIdent('not')) e.addChild(this._parseSupportsConditionInParens());
              ...
              (e.addChild(this._parseSupportsConditionInParens()), this.peekRegExp(s.TokenType.Ident, /^(and|or)$/i))
            )
          ...
          (e.prototype._parseSupportsConditionInParens = function() {
              ...
              return (
                ...
                e.addChild(this._tryToParseDeclaration()) || this._parseSupportsCondition()
                  ? this.accept(s.TokenType.ParenthesisR)
                    ...
                    : this.finish(e, l.ParseError.RightParenthesisExpected, [s.TokenType.ParenthesisR], [])
                  : this.finish(e, l.ParseError.ConditionExpected)
              );
            if (this.peek(s.TokenType.Ident)) {
              var t = this.mark();
              if ((this.consumeToken(), !this.hasWhitespace() && this.accept(s.TokenType.ParenthesisL))) {
            ...
            return this.finish(e, l.ParseError.LeftParenthesisExpected, [], [s.TokenType.ParenthesisL]);
          }),
          ...
          (e.prototype._parsePage = function() {
            ...
            if ((this.consumeToken(), e.addChild(this._parsePageSelector())))
              for (; this.accept(s.TokenType.Comma); )
                if (!e.addChild(this._parsePageSelector())) return this.finish(e, l.ParseError.IdentifierExpected);
          ...
          (e.prototype._parseUnknownAtRule = function() {
            ...
            e: for (;;) {
              switch (this.token.type) {
                ...
                case s.TokenType.CurlyR:
                  if ((n--, 0 < t && 0 === n)) {
                    if ((this.consumeToken(), 0 < r)) return this.finish(e, l.ParseError.RightSquareBracketExpected);
          ...
          (e.prototype._parseCombinator = function() {
            if (this.peekDelim('>')) {
              ...
              if (!this.hasWhitespace() && this.acceptDelim('>')) {
                if (!this.hasWhitespace() && this.acceptDelim('>'))
                  return (e.type = a.NodeType.SelectorCombinatorShadowPiercingDescendant), this.finish(e);
                this.restoreAtMark(t);
              }
            ...
            if (this.peekDelim('+')) {
              ...
              return this.consumeToken(), (e.type = a.NodeType.SelectorCombinatorSibling), this.finish(e);
            }
            if (this.peekDelim('~')) {
              e = this.create(a.Node);
              return this.consumeToken(), (e.type = a.NodeType.SelectorCombinatorAllSiblings), this.finish(e);
            }
          ...
          (e.prototype._parseAttrib = function() {
            ...
            return (
              ...
              e.setIdentifier(this._parseIdent())
                ? (e.setOperator(this._parseOperator()) && (e.setValue(this._parseBinaryExpr()), this.acceptIdent('i')),
          ...
          (e.prototype._parsePrio = function() {
            ...
            return this.accept(s.TokenType.Exclamation) && this.acceptIdent('important') ? this.finish(e) : null;
          }),
          ...
          (e.prototype._parseURLArgument = function() {
            var e = this.create(a.Node);
            return this.accept(s.TokenType.String) || this.accept(s.TokenType.BadString) || this.acceptUnquotedString()
              ? this.finish(e)
              : null;
          }),
          ...
          (e.prototype._parseFunction = function() {
            ...
            if (this.hasWhitespace() || !this.accept(s.TokenType.ParenthesisL)) return this.restoreAtMark(e), null;
          ...
          (e.prototype._parseFunctionIdentifier = function() {
            ...
            if (((e.referenceTypes = [a.ReferenceType.Function]), this.acceptIdent('progid'))) {
              if (this.accept(s.TokenType.Colon)) for (; this.accept(s.TokenType.Ident) && this.acceptDelim('.'); );
              return this.finish(e);
            }
            return this.consumeToken(), this.finish(e);
          }),
          ...
          (e.prototype._parseHexColor = function() {
            if (
              this.peekRegExp(s.TokenType.Hash, /^#([A-Fa-f0-9]{3}|[A-Fa-f0-9]{4}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{8})$/g)
            ) {
...
!(function(e) {
    ...
    i = (function() {
      ...
      return (
        ...
        (e.prototype.findScope = function(e, t) {
          return (
            void 0 === t && (t = 0),
            (this.offset <= e && this.offset + this.length > e + t) || (this.offset === e && this.length === t)
  ...
  var r = (function() {
    ...
    return (
        ...
        switch (e.type) {
          ...
          case d.NodeType.For:
            var t = e,
              n = t.getDeclarations();
            return (
              n && this.addSymbolToChildScope(n, t.variable, t.variable.getName(), void 0, d.ReferenceType.Variable), !0
            );
      ...
      (e.prototype.visitCustomPropertyDeclarationNode = function(e) {
        ...
        return this.addCSSVariable(e.getProperty(), e.getProperty().getName(), t, d.ReferenceType.Variable), !0;
      }),
  ...
  var a = (function() {
    ...
    return (
      ...
      (e.prototype.evaluateReferenceTypes = function(e) {
        ...
        return e.findAParent(d.NodeType.Selector, d.NodeType.ExtendsReference) ? [d.ReferenceType.Rule] : null;
      }),
      ...
      (t.difference = function(e, t, n) {
        ...
        for (r = 1; r < e.length + 1; ++r)
          for (o = 1; o < t.length + 1; ++o)
            e[r - 1] === t[o - 1] ? (s[r][o] = s[r - 1][o - 1] + 1) : (s[r][o] = Math.max(s[r - 1][o], s[r][o - 1]));
  ...
  (function(e) {
      ...
      H = (function() {
        ...
        return (
          ...
          (e.prototype.getTextEditChange = function(e) {
            if (R.is(e)) {
              ...
              if (!(i = this._textEditChanges[t.uri])) {
                ...
                this._workspaceEdit.documentChanges.push(n), (i = new G(r)), (this._textEditChanges[t.uri] = i);
              }
              return i;
            }
            if (
          ...
          (e.prototype.renameFile = function(e, t, n) {
            this.checkDocumentChanges(), this._workspaceEdit.documentChanges.push(I.create(e, t, n));
          }),
    ...
    (t.WorkspaceChange = H),
      ...
      ((O = R = t.VersionedTextDocumentIdentifier || (t.VersionedTextDocumentIdentifier = {})).create = function(e, t) {
      ...
      (N.is = function(e) {
        var t = e;
        return (
          se.defined(t) && se.string(t.uri) && se.string(t.languageId) && se.number(t.version) && se.string(t.text)
        );
      }),
      ...
      ((t.SignatureInformation || (t.SignatureInformation = {})).create = function(e, t) {
        for (var n = [], i = 2; i < arguments.length; i++) n[i - 2] = arguments[i];
        var r = { label: e };
        return se.defined(t) && (r.documentation = t), se.defined(n) ? (r.parameters = n) : (r.parameters = []), r;
      }),
    ...
    (t.DocumentSymbol = te),
      ...
      (Y.is = function(e) {
        var t = e;
        return (
          se.defined(t) && se.typedArray(t.diagnostics, y.is) && (void 0 === t.only || se.typedArray(t.only, se.string))
        );
      }),
  ...
  (function(e) {
      ...
      i = (function() {
        ...
        return (
          (e.prototype.getSymbolContext = function() {
            return this.symbolContext || (this.symbolContext = new n.Symbols(this.styleSheet)), this.symbolContext;
          }),
          ...
          (e.prototype.doComplete = function(e, t, n) {
            (this.offset = e.offsetAt(t)),
              ...
              (this.defaultReplaceRange = g.Range.create(
                g.Position.create(this.position.line, this.position.character - this.currentWord.length),
                this.position,
              )),
              (this.textDocument = e),
              (this.styleSheet = n);
            try {
              ...
              for (var r = this.nodePath.length - 1; 0 <= r; r--) {
                ...
                if (o instanceof m.Property) this.getCompletionsForDeclarationProperty(o.getParent(), i);
                  ...
                  if (s)
                    if (s.type === m.NodeType.ExtendsReference) this.getCompletionsForExtendsReference(s, o, i);
                    else {
                      var a = s;
                      this.getCompletionsForSelector(a, a && a.isNested(), i);
                    }
                } else if (o instanceof m.FunctionArgument) this.getCompletionsForFunctionArgument(o, o.getParent(), i);
                else if (o instanceof m.Declarations) this.getCompletionsForDeclarations(o, i);
                else if (o instanceof m.VariableDeclaration) this.getCompletionsForVariableDeclaration(o, i);
                ...
                else if (o instanceof m.FunctionDeclaration) this.getCompletionsForFunctionDeclaration(o, i);
                else if (o instanceof m.MixinReference) this.getCompletionsForMixinReference(o, i);
                else if (o instanceof m.Function) this.getCompletionsForFunctionArgument(null, o, i);
                else if (o instanceof m.Supports) this.getCompletionsForSupports(o, i);
                else if (o instanceof m.SupportsCondition) this.getCompletionsForSupportsCondition(o, i);
                else if (o instanceof m.ExtendsReference) this.getCompletionsForExtendsReference(o, null, i);
                else if (o.type === m.NodeType.URILiteral) this.getCompletionForUriLiteralValue(o, i);
          ...
          (e.prototype.getPropertyProposals = function(o, s) {
            ...
            return (
              ...
              this.completionParticipants.forEach(function(e) {
                e.onCssProperty && e.onCssProperty({ propertyName: a.currentWord, range: a.defaultReplaceRange });
              }),
              s
            );
          }),
          (e.prototype.getCompletionsForDeclarationValue = function(e, t) {
            for (
              var n = this, i = e.getFullPropertyName(), r = u.cssDataManager.getProperty(i), o = e.getValue();
              o && o.hasChildren();
              ...
              for (
                var l = 0,
                  c = (function(e, i) {
                    ...
                    function o(e) {
                      return (
                        (e instanceof m.Identifier || e instanceof m.NumericValue || e instanceof m.HexColorValue) &&
                          t.add(e.getText()),
                        !0
                      );
                    }
                    return (
                      e.accept(function(e) {
                        if (e instanceof m.Declaration && e !== i && ((n = e.getFullPropertyName()), r === n)) {
                          var t = e.getValue();
                          t && t.accept(o);
                        }
                        var n;
          ...
          (e.prototype.getVariableProposals = function(e, t) {
            for (
              var n = 0, i = this.getSymbolContext().findSymbolsAtOffset(this.offset, m.ReferenceType.Variable);
              n < i.length;
              n++
            ) {
              var r = i[n],
          ...
          (e.prototype.getVariableProposalsForCSSVarFunction = function(e) {
            for (
              var t = this.getSymbolContext().findSymbolsAtOffset(this.offset, m.ReferenceType.Variable),
                n = 0,
          ...
          (e.prototype.getUnitProposals = function(e, t, n) {
            ...
            if ((t && t.parent && t.parent.type === m.NodeType.Term && (t = t.getParent()), e.restrictions))
          ...
          (e.prototype.getCompletionsForDeclarations = function(e, t) {
            ...
            if (n instanceof m.AbstractDeclaration) {
              ...
              if (c(i.semicolonPosition) && i.semicolonPosition < this.offset)
                return this.offset === i.semicolonPosition + 1 ? t : this.getCompletionsForDeclarationProperty(null, t);
              ...
              n instanceof m.ExtendsReference
                ...
                : this.currentWord && '@' === this.currentWord[0] && this.getCompletionsForDeclarationProperty(null, t);
            return t;
          }),
          ...
          (e.prototype.getCompletionsForMixinReference = function(e, t) {
            for (
              var n = 0, i = this.getSymbolContext().findSymbolsAtOffset(this.offset, m.ReferenceType.Mixin);
              n < i.length;
              n++
            ) {
              var r = i[n];
          ...
          (e.prototype.getTermProposals = function(e, t, n) {
            for (
              var i = 0, r = this.getSymbolContext().findSymbolsAtOffset(this.offset, m.ReferenceType.Function);
              i < r.length;
              i++
            ) {
              var o = r[i];
          ...
          (e.prototype.getCompletionsForSupportsCondition = function(e, t) {
            ...
            if (n) {
              ...
              if (n instanceof m.SupportsCondition) return this.getCompletionsForSupportsCondition(n, t);
            }
            return c(e.lParent) && this.offset > e.lParent && (!c(e.rParent) || this.offset <= e.rParent)
          ...
          (e.prototype.getCompletionsForSupports = function(e, t) {
            ...
            if (!n || this.offset <= n.offset) {
              ...
              return i instanceof m.SupportsCondition ? this.getCompletionsForSupportsCondition(i, t) : t;
            }
          ...
          (e.prototype.getCompletionForUriLiteralValue = function(e, t) {
            ...
            return (
              this.completionParticipants.forEach(function(e) {
                e.onCssURILiteralValue && e.onCssURILiteralValue({ uriValue: n, position: i, range: r });
              }),
              t
            );
          }),
          (e.prototype.getCompletionForImportPath = function(t, e) {
            ...
            return (
              this.completionParticipants.forEach(function(e) {
                e.onCssImportPath &&
                  e.onCssImportPath({ pathValue: t.getText(), position: n.position, range: n.getCompletionRange(t) });
              }),
              e
            );
          }),
    ...
    var h = (function() {
      ...
      return (
        (e.prototype.visitNode = function(e) {
          return (
            (e instanceof m.HexColorValue || (e instanceof m.Function && u.isColorConstructor(e))) &&
...
!(function(e) {
    ...
    g = (function() {
      ...
      return (
        ...
        (s.prototype.addChild = function(e) {
          e instanceof s && (e.parent = this), this.children || (this.children = []), this.children.push(e);
        }),
      ...
      (e.prototype.processSelector = function(e) {
        ...
        if (
          ...
          n.parent instanceof c &&
            ((t = this.element), (this.element = n.parent), this.element.removeChild(n), (this.prev = null));
        }
        for (var i = 0, r = e.getChildren(); i < r.length; i++) {
          ...
          if (o instanceof f.SimpleSelector) {
            ...
            this.prev && this.prev.matches('~') && (this.element.addChild(p(o)), this.element.addChild(new d('⋮')));
            var a = p(o, t),
              l = a.findRoot();
        ...
        return (
          (e.prototype.doHover = function(t, e, n) {
            ...
            for (var r = t.offsetAt(e), o = h.getNodePath(n, r), s = 0; s < o.length; s++) {
              var a = o[s];
              if (a instanceof h.Selector) return { contents: f.selectorToMarkedString(a), range: i(a) };
              if (a instanceof h.SimpleSelector) return { contents: f.simpleSelectorToMarkedString(a), range: i(a) };
              if (a instanceof h.Declaration) {
                ...
                if (c) {
                  ...
                  if ((p && d.push(u.MarkedString.fromPlainText(p)), d.length)) return { contents: d, range: i(a) };
                }
              }
            }
            return null;
  ...
  (function(e) {
        ...
        return (
          ...
          (e.prototype.findDocumentHighlights = function(t, e, n) {
            var i = [],
              r = t.offsetAt(e),
              o = c.getNodeAtOffset(n, r);
            if (!o || o.type === c.NodeType.Stylesheet || o.type === c.NodeType.Declarations) return i;
          ...
          (e.prototype.getColorPresentations = function(e, t, n, i) {
            ...
            (r =
              ...
              (r = 1 === n.alpha ? '#' + f(s) + f(a) + f(l) : '#' + f(s) + f(a) + f(l) + f(Math.round(255 * n.alpha))),
              o.push({ label: r, textEdit: d.TextEdit.replace(i, r) });
            var c = h.hslFromColor(n);
            return (
              (r =
                1 === c.a
                  ? 'hsl(' + c.h + ', ' + Math.round(100 * c.s) + '%, ' + Math.round(100 * c.l) + '%)'
                  : 'hsla(' + c.h + ', ' + Math.round(100 * c.s) + '%, ' + Math.round(100 * c.l) + '%, ' + c.a + ')'),
              o.push({ label: r, textEdit: d.TextEdit.replace(i, r) }),
              o
            );
          }),
    ...
    function u(e) {
      ...
      if (e instanceof c.Identifier && e.parent && e.parent instanceof c.Property && e.isCustomProperty)
    ...
    (t.Setting = l),
      (t.Rules = {
        ...
        IncludeStandardPropertyWhenUsingVendorPrefix: new a(
          'vendorPrefix',
          i('rule.standardvendorprefix.all', 'When using a vendor-specific prefix also include the standard property'),
          r,
        ),
        ...
        RequiredPropertiesForFontFace: new a(
          'fontFaceProperties',
          i('rule.fontFaceProperties', "@font-face rule must define 'src' and 'font-family' properties"),
          r,
        ),
        ...
        UnknownProperty: new a('unknownProperties', i('rule.unknownProperty', 'Unknown property.'), r),
        UnknownAtRules: new a('unknownAtRules', i('rule.unknownAtRules', 'Unknown at-rule.'), r),
        IEStarHack: new a('ieHack', i('rule.ieHack', 'IE hacks are only necessary when supporting IE7 and older'), s),
            ...
            if (n.code === p.Rules.UnknownProperty.id)
              for (
                ...
                if (l instanceof d.Declaration) {
                  var c = l.getProperty();
                  if (c && c.offset === r && c.end === o) return void this.getFixesForUnknownProperty(e, c, n, i);
                }
              }
          }),
          e
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-css-languageservice/services/lintUtil', ['require', 'exports', '../utils/arrays'], e);
  })(function(e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 });
    ...
    function l(e, t, n, i) {
      ...
      'top' === t || 'right' === t || 'bottom' === t || 'left' === t
        ? a(e, t, n, i)
        : (a((r = e), 'top', (o = n), (s = i)), a(r, 'right', o, s), a(r, 'bottom', o, s), a(r, 'left', o, s));
    }
    function c(e, t, n) {
      switch (t.length) {
        case 1:
          ...
          break;
        case 2:
          l(e, 'top', t[0], n), l(e, 'bottom', t[0], n), l(e, 'right', t[1], n), l(e, 'left', t[1], n);
          break;
        case 3:
          l(e, 'top', t[0], n), l(e, 'right', t[1], n), l(e, 'left', t[1], n), l(e, 'bottom', t[2], n);
          break;
        case 4:
          l(e, 'top', t[0], n), l(e, 'right', t[1], n), l(e, 'bottom', t[2], n), l(e, 'left', t[3], n);
      }
    }
    function d(e, t) {
      return void 0 === t && (t = !0), (!t || !o.includes(['initial', 'unset'], e)) && 0 !== parseFloat(e);
    }
    function p(e, t) {
      return (
        void 0 === t && (t = !0),
    ...
    function h(e, t) {
      return (
        void 0 === t && (t = !0), !o.includes(['none', 'hidden'], e) && (!t || !o.includes(['initial', 'unset'], e))
      );
    }
    function m(e, t) {
      return (
              ...
              default:
                ...
                switch (s[0]) {
                  case 'border':
                    ...
                    break;
                  case 'padding':
                    1 === s.length ? c(t, p(o.getChildren(), !0), r) : l(t, s[1], d(o.getText(), !0), r);
                }
            }
        }
        return t;
      ...
      ne = (function() {
        ...
        return (
          (e.prototype.add = function(e, t, n) {
            var i = this.data[e];
            i || ((i = { nodes: [], names: [] }), (this.data[e] = i)), i.names.push(t), n && i.nodes.push(n);
          }),
          e
        );
      })(),
        ...
        return (
          ...
          (J.prototype.getMissingNames = function(e, t) {
            ...
            for (n = 0; n < e.length; n++) {
              var o = e[n];
              o &&
                (r = null === r ? te('namelist.single', "'{0}'", o) : te('namelist.concatenated', "{0}, '{1}'", r, o));
            }
            return r;
          }),
          ...
          (J.prototype.visitUnknownAtRule = function(e) {
            var t = e.getChild(0);
            return !!t && (this.addEntry(t, Y.Rules.UnknownAtRules, 'Unknown at rule ' + t.getText()), !0);
          }),
          ...
          (J.prototype.visitRuleSet = function(e) {
            ...
            if (0 < m.length)
              for (var u = 0, f = ['width', 'height', 'margin-top', 'margin-bottom', 'float']; u < f.length; u++)
              ...
              for (var I = new ne(), P = !1, _ = 0, A = t.getChildren(); _ < A.length; _++) {
                ...
                if (this.isCSSDeclaration(D)) {
                  ...
                  if ('-' === R) {
                    ...
                    var N = z;
                    ('*' !== R && '_' !== R) || (this.addEntry(o.getProperty(), Y.Rules.IEStarHack), (z = z.substr(1))),
          ...
          (J.prototype.visitHexColorValue = function(e) {
            var t = e.length;
            return 9 !== t && 7 !== t && 5 !== t && 4 !== t && this.addEntry(e, Y.Rules.HexColorLength), !1;
          }),
        ...
        return (
          ...
          (e.prototype.doValidation = function(i, e, t) {
            ...
            n.push.apply(n, s.ParseErrorCollector.entries(e)),
              n.push.apply(n, c.LintVisitor.entries(e, i, new l.LintConfigurationSettings(t && t.lint)));
            var r = [];
            ...
            return n
              ...
              .map(function(e) {
                var t = a.Range.create(i.positionAt(e.getOffset()), i.positionAt(e.getOffset() + e.getLength())),
                  n = i.languageId;
                return {
                  code: e.getRule().id,
                  source: n,
                  ...
                  severity:
                    e.getLevel() === s.Level.Warning ? a.DiagnosticSeverity.Warning : a.DiagnosticSeverity.Error,
                  range: t,
                };
              });
          }),
  ...
  (function(e) {
    ...
    (t.SCSSIssueType = i),
      (t.SCSSParseError = {
        ...
        ThroughOrToExpected: new i('scss-throughexpected', n('expected.through', "'through' or 'to' expected")),
    ...
    i = (function(i) {
      ...
      return (
        ...
        (e.prototype._parseVariableDeclaration = function(e) {
          ...
          return this.peek(s.TokenType.SemiColon) && (t.semicolonPosition = this.token.offset), this.finish(t);
        }),
        (e.prototype._parseMediaFeatureName = function() {
        ...
        (e.prototype._parseIdent = function(e) {
          var t = this;
          if (!this.peek(s.TokenType.Ident) && !this.peek(o.InterpolationFunction) && !this.peekDelim('-')) return null;
        ...
        (e.prototype._parseDeclaration = function(e) {
          ...
          var n = !1;
          if (
            (t.setValue(this._parseExpr()) && ((n = !0), t.addChild(this._parsePrio())), this.peek(s.TokenType.CurlyL))
          )
        ...
        (e.prototype._parseExtends = function() {
          if (this.peekKeyword('@extend')) {
            ...
            for (; this.accept(s.TokenType.Comma); ) e.getSelectors().addChild(this._parseSimpleSelector());
        ...
        (e.prototype._parseElementName = function() {
          ...
          return t && !this.hasWhitespace() && this.peek(s.TokenType.ParenthesisL) ? (this.restoreAtMark(e), null) : t;
        }),
        (e.prototype._tryParsePseudoIdentifier = function() {
        ...
        (e.prototype._parseReturnStatement = function() {
          ...
          return (
            this.consumeToken(),
            e.addChild(this._parseExpr()) ? this.finish(e) : this.finish(e, l.ParseError.ExpressionExpected)
          );
        }),
          ...
          return e.setIdentifier(this._parseVariable())
            ? (this.accept(o.Ellipsis),
              this.accept(s.TokenType.Colon) && !e.setDefaultValue(this._parseExpr(!0))
                ? this.finish(e, l.ParseError.VariableValueExpected, [], [s.TokenType.Comma, s.TokenType.ParenthesisR])
                : this.finish(e))
            : null;
        }),
        ...
        (e.prototype._parseMixinReference = function() {
          ...
          if (this.accept(s.TokenType.ParenthesisL)) {
            ...
            if (!this.accept(s.TokenType.ParenthesisR)) return this.finish(e, l.ParseError.RightParenthesisExpected);
          }
          if (this.peek(s.TokenType.CurlyL)) {
        ...
        (e.prototype._parseOperation = function() {
          if (!this.peek(s.TokenType.ParenthesisL)) return null;
          var e = this.create(a.Node);
          for (this.consumeToken(); e.addChild(this._parseListElement()); ) this.accept(s.TokenType.Comma);
          return this.accept(s.TokenType.ParenthesisR)
            ? this.finish(e)
            : this.finish(e, l.ParseError.RightParenthesisExpected);
        }),
    ...
    r = (function(r) {
      ...
      return (
        ...
        (o.prototype.getColorProposals = function(e, t, n) {
          return (
            this.createFunctionProposals(o.colorProposals, t, !1, n), r.prototype.getColorProposals.call(this, e, t, n)
          );
        }),
        ...
        (o.prototype.getCompletionsForExtendsReference = function(e, t, n) {
          for (
            var i = 0, r = this.getSymbolContext().findSymbolsAtOffset(this.offset, a.ReferenceType.Rule);
            i < r.length;
            i++
          ) {
            var o = r[i],
        ...
        (o.prototype.getCompletionForTopLevel = function(e) {
          return this.getCompletionForAtDirectives(e), r.prototype.getCompletionForTopLevel.call(this, e), e;
        }),
        (o.variableDefaults = {
          $red: '1',
          $green: '2',
        ...
        (o.colorProposals = [
          { func: 'red($color)', desc: i('scss.builtin.red', 'Gets the red component of a color.') },
          { func: 'green($color)', desc: i('scss.builtin.green', 'Gets the green component of a color.') },
          { func: 'blue($color)', desc: i('scss.builtin.blue', 'Gets the blue component of a color.') },
          { func: 'mix($color, $color, [$weight])', desc: i('scss.builtin.mix', 'Mixes two colors together.') },
          { func: 'hue($color)', desc: i('scss.builtin.hue', 'Gets the hue component of a color.') },
          {
            func: 'saturation($color)',
            desc: i('scss.builtin.saturation', 'Gets the saturation component of a color.'),
          },
          { func: 'lightness($color)', desc: i('scss.builtin.lightness', 'Gets the lightness component of a color.') },
          { func: 'adjust-hue($color, $degrees)', desc: i('scss.builtin.adjust-hue', 'Changes the hue of a color.') },
          { func: 'lighten($color, $amount)', desc: i('scss.builtin.lighten', 'Makes a color lighter.') },
          { func: 'darken($color, $amount)', desc: i('scss.builtin.darken', 'Makes a color darker.') },
          { func: 'saturate($color, $amount)', desc: i('scss.builtin.saturate', 'Makes a color more saturated.') },
          { func: 'desaturate($color, $amount)', desc: i('scss.builtin.desaturate', 'Makes a color less saturated.') },
          { func: 'grayscale($color)', desc: i('scss.builtin.grayscale', 'Converts a color to grayscale.') },
          { func: 'complement($color)', desc: i('scss.builtin.complement', 'Returns the complement of a color.') },
          { func: 'invert($color)', desc: i('scss.builtin.invert', 'Returns the inverse of a color.') },
          { func: 'alpha($color)', desc: i('scss.builtin.alpha', 'Gets the opacity component of a color.') },
          { func: 'opacity($color)', desc: 'Gets the alpha component (opacity) of a color.' },
          { func: 'rgba($color, $alpha)', desc: i('scss.builtin.rgba', 'Changes the alpha component for a color.') },
          { func: 'opacify($color, $amount)', desc: i('scss.builtin.opacify', 'Makes a color more opaque.') },
          { func: 'fade-in($color, $amount)', desc: i('scss.builtin.fade-in', 'Makes a color more opaque.') },
          {
            func: 'transparentize($color, $amount)',
            desc: i('scss.builtin.transparentize', 'Makes a color more transparent.'),
          },
          { func: 'fade-out($color, $amount)', desc: i('scss.builtin.fade-out', 'Makes a color more transparent.') },
          {
            func: 'adjust-color($color, [$red], [$green], [$blue], [$hue], [$saturation], [$lightness], [$alpha])',
            desc: i('scss.builtin.adjust-color', 'Increases or decreases one or more components of a color.'),
          },
          {
            func: 'scale-color($color, [$red], [$green], [$blue], [$saturation], [$lightness], [$alpha])',
            desc: i('scss.builtin.scale-color', 'Fluidly scales one or more properties of a color.'),
          },
          {
          ...
          },
          {
            ...
            desc: i('scss.builtin.ie-hex-str', 'Converts a color into the format understood by IE filters.'),
          },
        ]),
        (o.selectorFuncs = [
          {
          ...
          },
          {
            ...
            desc: i('scss.builtin.selector-append', 'Appends selectors to one another without spaces in between.'),
          },
          {
            func: 'selector-extend($selector, $extendee, $extender)',
            desc: i('scss.builtin.selector-extend', 'Extends $extendee with $extender within $selector.'),
          },
          {
            func: 'selector-replace($selector, $original, $replacement)',
            desc: i('scss.builtin.selector-replace', 'Replaces $original with $replacement within $selector.'),
          },
          {
          ...
          },
          {
            ...
            desc: i('scss.builtin.simple-selectors', 'Returns the simple selectors that comprise a compound selector.'),
          },
          {
            func: 'selector-parse($selector)',
            desc: i('scss.builtin.selector-parse', 'Parses a selector into the format returned by &.'),
          },
        ]),
        (o.builtInFuncs = [
          { func: 'unquote($string)', desc: i('scss.builtin.unquote', 'Removes quotes from a string.') },
          ...
          },
          {
            ...
            desc: i('scss.builtin.str-index', 'Returns the index of the first occurance of $substring in $string.'),
          },
          {
            func: 'str-slice($string, $start-at, [$end-at])',
            desc: i('scss.builtin.str-slice', 'Extracts a substring from $string.'),
          },
          { func: 'to-upper-case($string)', desc: i('scss.builtin.to-upper-case', 'Converts a string to upper case.') },
          { func: 'to-lower-case($string)', desc: i('scss.builtin.to-lower-case', 'Converts a string to lower case.') },
          {
            func: 'percentage($number)',
            desc: i('scss.builtin.percentage', 'Converts a unitless number to a percentage.'),
            type: 'percentage',
          },
          { func: 'round($number)', desc: i('scss.builtin.round', 'Rounds a number to the nearest whole number.') },
          { func: 'ceil($number)', desc: i('scss.builtin.ceil', 'Rounds a number up to the next whole number.') },
          {
            func: 'floor($number)',
            desc: i('scss.builtin.floor', 'Rounds a number down to the previous whole number.'),
          },
          { func: 'abs($number)', desc: i('scss.builtin.abs', 'Returns the absolute value of a number.') },
          { func: 'min($numbers)', desc: i('scss.builtin.min', 'Finds the minimum of several numbers.') },
          { func: 'max($numbers)', desc: i('scss.builtin.max', 'Finds the maximum of several numbers.') },
          { func: 'random([$limit])', desc: i('scss.builtin.random', 'Returns a random number.') },
          { func: 'length($list)', desc: i('scss.builtin.length', 'Returns the length of a list.') },
          { func: 'nth($list, $n)', desc: i('scss.builtin.nth', 'Returns a specific item in a list.') },
          { func: 'set-nth($list, $n, $value)', desc: i('scss.builtin.set-nth', 'Replaces the nth item in a list.') },
          {
          ...
          {
            func: 'zip($lists)',
            desc: i('scss.builtin.zip', 'Combines several lists into a single multidimensional list.'),
          },
          {
            func: 'index($list, $value)',
            desc: i('scss.builtin.index', 'Returns the position of a value within a list.'),
          },
          { func: 'list-separator(#list)', desc: i('scss.builtin.list-separator', 'Returns the separator of a list.') },
          {
            func: 'map-get($map, $key)',
            desc: i('scss.builtin.map-get', 'Returns the value in a map associated with a given key.'),
          },
          {
          ...
          { func: 'map-keys($map)', desc: i('scss.builtin.map-keys', 'Returns a list of all keys in a map.') },
          { func: 'map-values($map)', desc: i('scss.builtin.map-values', 'Returns a list of all values in a map.') },
          {
            func: 'map-has-key($map, $key)',
            desc: i('scss.builtin.map-has-key', 'Returns whether a map has a value associated with a given key.'),
          },
          {
            func: 'keywords($args)',
            desc: i(
          ...
          },
          {
            ...
            desc: i('scss.builtin.feature-exists', 'Returns whether a feature exists in the current Sass runtime.'),
          },
          {
          ...
          },
          {
            ...
            desc: i('scss.builtin.function-exists', 'Returns whether a function with the given name exists.'),
          },
          {
            func: 'mixin-exists($name)',
            desc: i('scss.builtin.mixin-exists', 'Returns whether a mixin with the given name exists.'),
          },
          {
            func: 'inspect($value)',
            desc: i(
          ...
          { func: 'type-of($value)', desc: i('scss.builtin.type-of', 'Returns the type of a value.') },
          { func: 'unit($number)', desc: i('scss.builtin.unit', 'Returns the unit(s) associated with a number.') },
          { func: 'unitless($number)', desc: i('scss.builtin.unitless', 'Returns whether a number has units.') },
          {
            func: 'comparable($number1, $number2)',
            desc: i('scss.builtin.comparable', 'Returns whether two numbers can be added, subtracted, or compared.'),
          },
          { func: 'call($name, $args…)', desc: i('scss.builtin.call', 'Dynamically calls a Sass function.') },
        ]),
        (o.scssAtDirectives = [
          {
            label: '@extend',
      ...
      (e.prototype.escapedJavaScript = function() {
        return this.stream.peekChar() === l
          ? (this.stream.advance(1),
            ...
            this.stream.advanceIfChar(l) ? t.TokenType.EscapedJavaScript : t.TokenType.BadEscapedJavaScript)
          : null;
      }),
      e
    );
      ...
      return (
        ...
        (e.prototype._parseVariableDeclaration = function(e) {
          ...
          var t = this.create(s.VariableDeclaration),
            n = this.mark();
          if ((!this.peekDelim('@') && !this.peek(o.TokenType.AtKeyword)) || !t.setVariable(this._parseVariable()))
            return null;
          ...
          if (((t.colonPosition = this.prevToken.offset), t.setValue(this._parseDetachedRuleSet())))
            t.needsSemicolon = !1;
          else if (!t.setValue(this._parseExpr())) return this.finish(t, a.ParseError.VariableValueExpected, [], e);
          return (
            t.addChild(this._parsePrio()),
        ...
        (e.prototype._parseVariable = function() {
          if (!this.peekDelim('@') && !this.peekDelim('$') && !this.peek(o.TokenType.AtKeyword)) return null;
          for (var e = this.create(s.Variable), t = this.mark(); this.acceptDelim('@') || this.acceptDelim('$'); )
        ...
        (e.prototype._parseEscaped = function() {
          if (this.peek(o.TokenType.EscapedJavaScript) || this.peek(o.TokenType.BadEscapedJavaScript)) {
        ...
        (e.prototype._parsePropertyIdentifier = function() {
          ...
          return (
            t && !this.hasWhitespace() && (this.acceptDelim('+'), this.hasWhitespace() || this.acceptIdent('_')),
            t ? this.finish(e) : null
          );
        }),
        (e.prototype.peekInterpolatedIdent = function() {
          return this.peek(o.TokenType.Ident) || this.peekDelim('@') || this.peekDelim('$') || this.peekDelim('-');
        }),
        ...
        (e.prototype._tryParseMixinDeclaration = function() {
          ...
          if (!t.setIdentifier(this._parseMixinDeclarationIdentifier()) || !this.accept(o.TokenType.ParenthesisL))
        ...
        (e.prototype._completeExtends = function(e) {
          if (!this.accept(o.TokenType.ParenthesisL)) return this.finish(e, a.ParseError.LeftParenthesisExpected);
          var t = e.getSelectors();
          if (!t.addChild(this._parseSelector(!0))) return this.finish(e, a.ParseError.SelectorExpected);
        ...
        (e.prototype._parseDetachedRuleSetMixin = function() {
          ...
          return !t.addChild(this._parseVariable()) || (!this.hasWhitespace() && this.accept(o.TokenType.ParenthesisL))
        ...
        (e.prototype._tryParseMixinReference = function() {
          for (
            var e = this.mark(), t = this.create(s.MixinReference), n = this._parseMixinDeclarationIdentifier();
            n;
          ...
          if (!this.hasWhitespace() && this.accept(o.TokenType.ParenthesisL)) {
            ...
            if (!this.accept(o.TokenType.ParenthesisR)) return this.finish(t, a.ParseError.RightParenthesisExpected);
            n.referenceTypes = [s.ReferenceType.Mixin];
          } else n.referenceTypes = [s.ReferenceType.Mixin, s.ReferenceType.Rule];
          return (
            t.addChild(this._parsePrio()),
            r || this.peek(o.TokenType.SemiColon) || this.peek(o.TokenType.CurlyR) || this.peek(o.TokenType.EOF)
              ? this.finish(t)
              : (this.restoreAtMark(e), null)
          );
        }),
        ...
        (e.prototype._parseMixinParameter = function() {
          ...
          if (this.peekKeyword('@rest')) {
            ...
            return (
              ...
              this.accept(r.Ellipsis)
                ...
                : this.finish(e, a.ParseError.DotExpected, [], [o.TokenType.Comma, o.TokenType.ParenthesisR])
            );
          }
          ...
          return (
            ...
            e.setDefaultValue(this._parseDetachedRuleSet() || this._parseExpr(!0)) || i ? this.finish(e) : null
          );
        }),
        ...
        (e.prototype._parseFunction = function() {
          ...
          if (!t.setIdentifier(this._parseFunctionIdentifier())) return null;
          if (this.hasWhitespace() || !this.accept(o.TokenType.ParenthesisL)) return this.restoreAtMark(e), null;
          if (t.getArguments().addChild(this._parseMixinArgument()))
            for (
              ;
              (this.accept(o.TokenType.Comma) || this.accept(o.TokenType.SemiColon)) &&
        ...
        (e.prototype._parseFunctionIdentifier = function() {
          if (this.peekDelim('%')) {
            var e = this.create(s.Identifier);
            return (e.referenceTypes = [s.ReferenceType.Function]), this.consumeToken(), this.finish(e);
          }
...
!(function(e) {
    ...
    r = (function(r) {
      ...
      return (
        ...
        (o.builtInProposals = [
          ...
          { name: 'e', example: 'e(@string);', description: i('less.builtin.e', 'escape string content') },
          {
            name: 'replace',
          ...
          { name: 'abs', description: i('less.builtin.abs', 'absolute value of a number'), example: 'abs(number);' },
          {
            name: 'acos',
          ...
          { name: 'ceil', example: 'ceil(@number);', description: i('less.builtin.ceil', 'rounds up to an integer') },
          { name: 'cos', description: i('less.builtin.cos', 'cosine function'), example: 'cos(number);' },
          {
            name: 'floor',
          ...
          { name: 'sin', description: i('less.builtin.sin', 'sine function'), example: 'sin(number);' },
          { name: 'tan', description: i('less.builtin.tan', 'tangent function'), example: 'tan(number);' },
          {
            name: 'atan',
        ...
        (o.colorProposals = [
          { name: 'argb', example: 'argb(@color);', description: i('less.builtin.argb', 'creates a #AARRGGBB') },
          {
            name: 'hsl',
  ...
  (function(e) {
    ...
    function w(e, t) {
      ...
      for (var n = e.length - 1; 0 <= n; n--) if (e[n].type === t && e[n].isStart) return e.splice(n, 1)[0];
      return null;
    }
                ...
                switch (g.type) {
                  ...
                  case b.TokenType.CurlyR:
                    if (0 !== m.length) {
                      ...
                      var t = p(g);
                      'brace' === e.type &&
                        (p(f) !== t && t--, e.line !== t && h.push({ startLine: e.line, endLine: t, kind: void 0 }));
                    }
                    break;
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-css-languageservice/cssLanguageTypes', ['require', 'exports', 'vscode-languageserver-types'], e);
  })(function(e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 });
    var n,
        ...
        return (function(e) {
          ...
          for (var n = []; t; )
            (t.parent && t.offset === t.parent.offset && t.end === t.parent.end) ||
              (t.type === o.NodeType.Declarations ? n.push([t.offset + 1, t.end - 1]) : n.push([t.offset, t.end])),
              (t = t.parent);
          return n;
        })(e).map(function(e) {
          return {
      ...
      return (
        ...
        (e.prototype._getTextDocument = function(e) {
          for (var t = 0, n = this._ctx.getMirrorModels(); t < n.length; t++) {
            var i = n[t];
            if (i.uri.toString() === e) return r.TextDocument.create(e, this._languageId, i.version, i.getValue());
          }
          return null;
        }),
        e
