...
define('vs/language/html/workerManager', ['require', 'exports'], function(e, t) {
  ...
  (function(e) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      ...
      ((h = p = t.DiagnosticRelatedInformation || (t.DiagnosticRelatedInformation = {})).create = function(e, t) {
          ...
          (e.prototype.getTextEditChange = function(e) {
            if (A.is(e)) {
              ...
              if (!(r = this._textEditChanges[t.uri])) {
                ...
                this._workspaceEdit.documentChanges.push(n), (r = new $(i)), (this._textEditChanges[t.uri] = r);
              }
              return r;
            }
            if (
    ...
    (t.WorkspaceChange = Q),
      ...
      ((P = A = t.VersionedTextDocumentIdentifier || (t.VersionedTextDocumentIdentifier = {})).create = function(e, t) {
      ...
      ((t.SignatureInformation || (t.SignatureInformation = {})).create = function(e, t) {
        for (var n = [], r = 2; r < arguments.length; r++) n[r - 2] = arguments[r];
        var i = { label: e };
        return ae.defined(t) && (i.documentation = t), ae.defined(n) ? (i.parameters = n) : (i.parameters = []), i;
      }),
  ...
  define('vs/language/html/languageFeatures', ['require', 'exports', 'vscode-languageserver-types'], function(e, t, a) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 });
    var u = monaco.Range,
      n = (function() {
    ...
    function c(e) {
      if (e) return new u(e.start.line + 1, e.start.character + 1, e.end.line + 1, e.end.character + 1);
    }
    function d(e) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.setupMode = function(e) {
        ...
        monaco.languages.registerCompletionItemProvider(r, new o.CompletionAdapter(t)),
          ...
          'html' === r &&
            (monaco.languages.registerDocumentFormattingEditProvider(r, new o.DocumentFormattingEditProvider(t)),
