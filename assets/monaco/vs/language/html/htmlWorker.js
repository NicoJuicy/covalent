...
define('vscode-nls/vscode-nls', ['require', 'exports'], function(e, t) {
      ...
      return {
        scan: function() {
            ...
            n = (function e() {
              ...
              switch (p) {
                  ...
                  if (u.advanceIfChar(y)) {
                    if (!u.eos() && u.peekChar() === b) {
                      if (u.advanceIfChars([b, v, v]))
                        return (p = g.ScannerState.WithinComment), f(n, g.TokenType.StartCommentTag);
                      if (u.advanceIfRegExp(/^!doctype/i))
                        return (p = g.ScannerState.WithinDoctype), f(n, g.TokenType.StartDoctypeTag);
                    }
                ...
                case g.ScannerState.AfterOpeningEndTag:
                  ...
                  return 0 < i.length
                    ...
                    ? f(
                        ...
                        _('error.unexpectedWhitespace', 'Tag name must directly follow the open bracket.'),
                      )
                    : ((p = g.ScannerState.WithinEndTag),
                      u.advanceUntilChar(w),
                      n < u.pos()
                        ? f(n, g.TokenType.Unknown, _('error.endTagNameExpected', 'End tag name expected.'))
                        : e());
                case g.ScannerState.WithinEndTag:
                  if (u.skipWhitespace()) return f(n, g.TokenType.Whitespace);
                  if (u.advanceIfChar(w)) return (p = g.ScannerState.WithinContent), f(n, g.TokenType.EndTagClose);
                  ...
                  return (
                    ...
                    0 < c.length
                      ...
                      : ((p = g.ScannerState.WithinTag),
                        u.advanceUntilChar(w),
                        n < u.pos()
                          ? f(n, g.TokenType.Unknown, _('error.startTagNameExpected', 'Start tag name expected.'))
                          : e())
                  );
                case g.ScannerState.WithinTag:
                  return u.skipWhitespace()
                    ? ((l = !0), f(n, g.TokenType.Whitespace))
                    : l && 0 < (h = u.advanceIfRegExp(/^[^\s"'>/=\x00-\x0F\x7F\x80-\x9F]*/).toLowerCase()).length
                    ? ((p = g.ScannerState.AfterAttributeName), (l = !1), f(n, g.TokenType.AttributeName))
                    ...
                    : (u.advance(1),
                      f(n, g.TokenType.Unknown, _('error.unexpectedCharacterInTag', 'Unexpected character in tag.')));
                ...
                case g.ScannerState.WithinScriptContent:
                  ...
                  return (p = g.ScannerState.WithinContent), n < u.pos() ? f(n, g.TokenType.Script) : e();
          ...
          return n !== g.TokenType.EOS && e === u.pos()
            ? (console.log('Scanner.scan has not advanced at offset ' + e + ', state before: ' + t + ' after: ' + p),
              u.advance(1),
        ...
        for (
          ...
          switch (s) {
            ...
            case p.TokenType.StartTagSelfClose:
              i.parent &&
                ((i.closed = !0), (i.end = t.getTokenEnd()), (i.startTagEnd = t.getTokenEnd()), (i = i.parent));
              break;
  ...
  (function(e) {
      ...
      J = (function() {
        ...
        return (
          ...
          (e.prototype.getTextEditChange = function(e) {
            if (q.is(e)) {
              ...
              if (!(i = this._textEditChanges[t.uri])) {
                ...
                this._workspaceEdit.documentChanges.push(n), (i = new K(r)), (this._textEditChanges[t.uri] = i);
              }
              return i;
            }
            if (
          ...
          (e.prototype.renameFile = function(e, t, n) {
            this.checkDocumentChanges(), this._workspaceEdit.documentChanges.push(C.create(e, t, n));
          }),
    ...
    (t.WorkspaceChange = J),
      ...
      ((O = q = t.VersionedTextDocumentIdentifier || (t.VersionedTextDocumentIdentifier = {})).create = function(e, t) {
    ...
    (t.DocumentSymbol = te),
      ...
      ($.is = function(e) {
        var t = e;
        return (
          oe.defined(t) && oe.typedArray(t.diagnostics, b.is) && (void 0 === t.only || oe.typedArray(t.only, oe.string))
        );
      }),
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-html-languageservice/languageFacts/data/html5Tags', ['require', 'exports'], e);
  })(function(e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.HTML5_TAGS = [
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-html-languageservice/languageFacts/data/html5Events', ['require', 'exports'], e);
  })(function(e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.HTML5_EVENTS = [
  ...
  (function(e) {
    if ('object' == typeof module && 'object' == typeof module.exports) {
      ...
      'function' == typeof define &&
        define.amd &&
        define('vscode-html-languageservice/languageFacts/data/html5Aria', ['require', 'exports'], e);
  })(function(e, t) {
    'use strict';
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.ARIA_ATTRIBUTES = [
  ...
  (function(e) {
        ...
        return (
          ...
          (e.prototype.doComplete = function(g, _, s, i) {
            ...
            var S,
              ...
              x = '';
            function k(e, t) {
              return void 0 === t && (t = T), T < e && (e = T), { start: g.positionAt(e), end: g.positionAt(t) };
            }
            function n(e, t) {
              var n = k(e, t);
              return (
              ...
              for (t && (a = a.parent); a; ) {
                ...
                if (o && (!a.closed || (a.endTagStart && a.endTagStart > T))) {
                  ...
                  if (null !== l && null !== c && l !== c) {
                    var h = l + '</' + o + r;
                    (s.textEdit = A.TextEdit.replace(k(e - 1 - c.length), h)), (s.filterText = c + '</' + o + r);
                  }
            ...
            function o(e, t) {
              ...
              var i = k(e, n),
                r = R(w, t, U.ScannerState.AfterAttributeName, U.TokenType.DelimiterAssign) ? '' : '="$1"',
                a = x.toLowerCase(),
                ...
                y.forEach(function(e) {
                  e.provideAttributes(a).forEach(function(e) {
                    if (!o[e.name]) {
                      ...
                      'v' !== e.valueSet &&
                        r.length &&
                        ((n += r), e.valueSet && (t = { title: 'Suggest', command: 'editor.action.triggerSuggest' })),
                        b.items.push({
                          label: e.name,
                          kind: 'handler' === e.valueSet ? A.CompletionItemKind.Function : A.CompletionItemKind.Value,
                          documentation: e.description,
              ...
              if (0 < v.length)
                for (var u = k(e, t), p = 0, m = v; p < m.length; p++) {
                  ...
                  f.onHtmlAttributeValue &&
                    f.onHtmlAttributeValue({ document: g, position: _, tag: h, attribute: d, value: r, range: u });
                }
              return (
                y.forEach(function(e) {
            ...
            function c(e) {
              return T === t.getTokenEnd() && (m = t.scan()) === e && t.getTokenOffset() === T ? t.getTokenEnd() : T;
            }
            function h() {
                ...
                for (var i in M.entities)
                  if (H.endsWith(i, ';')) {
                    ...
                    b.items.push({
                      ...
                      documentation: D('entity.propose', "Character entity representing '" + M.entities[i] + "'"),
            ...
            for (var p, m = t.scan(); m !== U.TokenType.EOS && t.getTokenOffset() <= T; ) {
              switch (m) {
                ...
                case U.TokenType.StartTag:
                  if (t.getTokenOffset() <= T && T <= t.getTokenEnd()) return n(t.getTokenOffset(), t.getTokenEnd());
                  x = t.getTokenText();
                  break;
                case U.TokenType.AttributeName:
                  if (t.getTokenOffset() <= T && T <= t.getTokenEnd()) return o(t.getTokenOffset(), t.getTokenEnd());
                  S = t.getTokenText();
                  break;
                ...
                case U.TokenType.AttributeValue:
                  if (t.getTokenOffset() <= T && T <= t.getTokenEnd()) return l(t.getTokenOffset(), t.getTokenEnd());
                  break;
                ...
                case U.TokenType.EndTagOpen:
                  if (T <= t.getTokenEnd()) return r(t.getTokenOffset() + 1, !1, c(U.TokenType.EndTag));
                  break;
            ...
            if ('>' === r) {
              if (
                ...
                for (
                  ...
                  if (a === U.TokenType.StartTagClose && s.getTokenEnd() === i) return '$0</' + o.tag + '>';
                  a = s.scan();
                }
            } else if ('/' === r) {
    ...
    function R(e, t, n, i) {
      for (var r = I.createScanner(e, t, n), a = r.scan(); a === U.TokenType.Whitespace; ) a = r.scan();
      return a === i;
    }
    t.HTMLCompletion = i;
  }),
              ...
              if (
                (e.provideTags().forEach(function(e) {
                  if (e.name.toLowerCase() === r.toLowerCase()) {
                    var t = o ? '<' + r + '>' : '</' + r + '>',
                      n = e.description || '';
                    i = { contents: [{ language: 'html', value: t }, d.MarkedString.fromPlainText(n)], range: a };
                  }
                }),
                i)
              )
        ...
        (r.prototype.clone_empty = function() {
          ...
          (a.prototype.set_indent = function(e, t) {
            return (
              ...
              1 < this.__lines.length ? (this.current_line.set_indent(e, t), !0) : (this.current_line.set_indent(), !1)
            );
          }),
      ...
      function(e, t, n) {
        ...
        (i.prototype.restart = function() {
          ...
          (i.prototype.peek = function(e) {
            var t = null;
            return (
              (e = e || 0), 0 <= (e += this.__position) && e < this.__input_length && (t = this.__input.charAt(e)), t
            );
          }),
          ...
          (i.prototype.get_regexp = function(e, t) {
            ...
            return (
              t && r && (i = 'y'),
              'string' == typeof e && '' !== e ? (n = new RegExp(e, i)) : e && (n = new RegExp(e.source, i)),
              n
            );
          }),
        ...
        (r.prototype.eatString = function(e) {
          ...
          (r.prototype.beautify = function() {
            ...
            for (
              ...
              (i = '' !== this._input.read(w)), (r = d), (this._ch = this._input.next()), (d = this._ch), this._ch;
              ...
              if ('/' === this._ch && '*' === this._input.peek()) {
                ...
                '#' === this._ch && '{' === this._input.peek()
                  ...
                  ? (!o && !l) ||
                    ...
                    ? (this._input.lookBack(' ') && (this._output.space_before_token = !0),
                      ':' === this._input.peek()
                        ...
                        : this.print_string(':'))
                    : (this.print_string(':'),
                      s || ((s = !0), (this._output.space_before_token = !0), this.eatWhitespace(!0), this.indent()))
                  : '"' === this._ch || "'" === this._ch
                  ...
                  ? this._input.lookBack('url')
                    ...
                    : (a++, this.preserveSingleSpace(i), this.print_string(this._ch), this.eatWhitespace())
                  : ')' === this._ch
                  ...
                  : '=' === this._ch
                  ? (this.eatWhitespace(), this.print_string('='), y.test(this._ch) && (this._ch = ''))
      ...
      function(e, t, n) {
        ...
        (l.prototype.tokenize = function() {
          ...
          for (var t = new a(s.START, ''), n = null, i = [], r = new o(); t.type !== s.EOF; ) {
            for (e = this._get_next_token(t, n); this._is_comment(e); ) r.add(e), (e = this._get_next_token(t, n));
            r.isEmpty() || ((e.comments_before = r), (r = new o())),
              (e.parent = n),
              this._is_opening(e)
                ? (i.push(n), (n = e))
                : n && this._is_closing(e, n) && (((e.opened = n).closed = e), (n = i.pop()), (e.parent = n)),
              ((e.previous = t).next = e),
              this.__tokens.add(e),
              (t = e);
          }
            ...
            if ('<' === t) {
              ...
              '{' === t &&
                (this._disabled.handlebars ||
                  ...
                  (e = (e = e || this.__patterns.handlebars_comment.read()) || this.__patterns.handlebars.read()),
                this._disabled.django ||
      ...
      function(e, t, n) {
        ...
        (m.prototype.get_parser_token = function() {
            ...
            if ((e.set_space_before_token(t.newlines || '' !== t.whitespace_before, !0), n.is_unformatted))
              ...
              if (
                (t.type === h.ATTRIBUTE
                  ...
                  : t.type === h.VALUE && t.previous.type === h.EQUALS && e.set_space_before_token(!1),
                t.type === h.ATTRIBUTE &&
                  '<' === n.tag_start_char &&
          ...
          (f.prototype._handle_tag_open = function(e, t, n, i) {
            ...
            return (
              (n.is_unformatted || n.is_content_unformatted) && t.type === h.TAG_OPEN && 0 === t.text.indexOf('</')
                ? e.add_raw_token(t)
        ...
        var g = function(e, t) {
          ...
          t)
            ? ((this.tag_start_char = t.text[0]),
              (this.text = t.text),
              (n = '<' === this.tag_start_char ? t.text.match(/^<([^\s>]*)/) : t.text.match(/^{{[#\^]?([^\s}]+)/)),
        ...
        (f.prototype._get_tag_open_token = function(e) {
          ...
          return (
            ...
            (t.is_content_unformatted = !t.is_empty_element && s(t.tag_check, this._options.content_unformatted)),
          ...
          (f.prototype._set_tag_position = function(e, t, n, i, r) {
            if (
              ...
              ('!--' === n.tag_name && r.type === h.TAG_CLOSE && i.is_end_tag && -1 === n.text.indexOf('\n')) ||
                n.is_inline_element ||
                n.is_unformatted ||
                e.print_newline(!1);
            } else
              ...
              return (
                'body' === e.tag_name
                  ...
                  : ('th' !== e.tag_name && 'td' !== e.tag_name) ||
                    (t = (t = t || this._tag_stack.try_pop('td', ['tr'])) || this._tag_stack.try_pop('th', ['tr'])),
                      ...
                      (n =
                        (n =
                          (n =
                            ...
                            this._read_raw_content(e, t)) || this._read_close(i, t)) || this._read_content_word(i)) ||
                ...
                (this._options.indent_handlebars &&
                  ...
                  (i =
                    '!' === this._input.peek(2)
                      ...
                      : ((n = this.__patterns.handlebars_open.read()), this._create_token(l.TAG_OPEN, n)))),
              i
            );
          }),
  ...
  (function(e) {
    ...
    t.format = function(e, t, n) {
      ...
      if (t) {
        ...
        (h === i.length || w(i, h)) && (c = h), (t = g.Range.create(e.positionAt(s), e.positionAt(c)));
        var d = i.substring(0, s);
        if (new RegExp(/.*[<][^>]*$/).test(d)) return [{ range: t, newText: (i = i.substring(s, c)) }];
...
!(function(e) {
      ...
      return (
        ...
        (n.file = function(e) {
          ...
          if ((i && (e = e.replace(/\\/g, u)), e[0] === u && e[1] === u)) {
            var n = e.indexOf(u, 2);
            e = -1 === n ? ((t = e.substring(2)), u) : ((t = e.substring(2, n)), e.substring(n) || u);
          }
  ...
  function m(e) {
    for (var t = void 0, n = 0; n < e.length; n++) {
      ...
      35 === i || 63 === i ? (void 0 === t && (t = e.substr(0, n)), (t += d[i])) : void 0 !== t && (t += e[n]);
    }
    return void 0 !== t ? t : e;
  }
  function f(e) {
  ...
  function g(e, t) {
    ...
    if (o) {
      if (3 <= o.length && 47 === o.charCodeAt(0) && 58 === o.charCodeAt(2))
        65 <= (d = o.charCodeAt(1)) && d <= 90 && (o = '/' + String.fromCharCode(d + 32) + ':' + o.substr(3));
  ...
  (function(e) {
    ...
    function g(e, t) {
      var n = e[0];
      return n !== e[e.length - 1] || ("'" !== n && '"' !== n) || (e = e.substr(1, e.length - 2)), e;
    }
        ...
        switch (r) {
          ...
          case f.TokenType.AttributeValue:
            if (a) {
              ...
              o && void 0 === s && (s = g(c, e.languageId)) && t && (s = t.resolveReference(s, e.uri)), (a = o = !1);
            }
        }
        r = i.scan();
      }
  ...
  (function(e) {
    ...
    function d(e, t, n) {
      for (var i = a.createScanner(t.getText(), n), r = i.scan(); r !== c.TokenType.EOS && r !== e; ) r = i.scan();
            ...
            if (m)
              if (m[1]) a.push({ startLine: h, tagName: '' });
                ...
                if (0 <= d) {
                  (u = a[d]), (a.length = d);
                  var f = h;
                  (h = u.startLine) < f && s !== h && l({ startLine: h, endLine: f, kind: _.FoldingRangeKind.Region });
                }
              }
            else
