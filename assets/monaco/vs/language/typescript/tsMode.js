      ...
      (e.prototype._updateExtraLibs = function() {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(e) {
            switch (e.label) {
              case 0:
                return this._worker ? ((t = ++this._updateExtraLibsToken), [4, this._worker.getProxy()]) : [2];
              case 1:
                return (
                  (n = e.sent()),
                  this._updateExtraLibsToken !== t ? [2] : (n.updateExtraLibs(this._defaults.getExtraLibs()), [2])
                );
            }
          });
        });
                ...
                e.items.forEach(function(i) {
                  ...
                  (a.label += l(i.prefixDisplayParts)),
                    i.parameters.forEach(function(e, t, n) {
                      ...
                      (a.label += r), a.parameters.push(o), t < n.length - 1 && (a.label += l(i.separatorDisplayParts));
                    }),
          ...
          .then(function(e) {
            if (e) {
              for (var t = [], n = 0, r = e; n < r.length; n++) {
                ...
                monaco.editor.getModel(i) && t.push({ uri: i, range: a._textSpanToRange(i, o.textSpan) });
              }
              return t;
            }
          });
