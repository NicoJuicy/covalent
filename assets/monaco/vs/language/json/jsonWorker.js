...
!(function(e) {
  ...
  Object.defineProperty(t, '__esModule', { value: !0 }),
    ...
    ((h = t.FoldingRange || (t.FoldingRange = {})).create = function(e, t, r, n, o) {
      ...
      return (
        ae.defined(r) && (i.startCharacter = r), ae.defined(n) && (i.endCharacter = n), ae.defined(o) && (i.kind = o), i
      );
    }),
    (h.is = function(e) {
      var t = e;
    ...
    ((g = m = t.DiagnosticRelatedInformation || (t.DiagnosticRelatedInformation = {})).create = function(e, t) {
        ...
        (e.prototype.getTextEditChange = function(e) {
          if (D.is(e)) {
            ...
            if (!(n = this._textEditChanges[t.uri])) {
              ...
              this._workspaceEdit.documentChanges.push(r), (n = new H(o)), (this._textEditChanges[t.uri] = n);
            }
            return n;
          }
          if (
  ...
  (t.WorkspaceChange = z),
    ...
    ((V = D = t.VersionedTextDocumentIdentifier || (t.VersionedTextDocumentIdentifier = {})).create = function(e, t) {
    ...
    (_.is = function(e) {
      var t = e;
      return ae.defined(t) && ae.string(t.uri) && ae.string(t.languageId) && ae.number(t.version) && ae.string(t.text);
    }),
    ...
    ((t.SignatureInformation || (t.SignatureInformation = {})).create = function(e, t) {
      for (var r = [], n = 2; n < arguments.length; n++) r[n - 2] = arguments[n];
      var o = { label: e };
      return ae.defined(t) && (o.documentation = t), ae.defined(r) ? (o.parameters = r) : (o.parameters = []), o;
    }),
  ...
  (t.DocumentSymbol = te),
    ...
    (Z.is = function(e) {
      var t = e;
      return (
        ae.defined(t) && ae.typedArray(t.diagnostics, y.is) && (void 0 === t.only || ae.typedArray(t.only, ae.string))
      );
    }),
      ...
      (t.createScanner = function(i, e) {
        ...
        function t() {
          ...
          switch (e) {
            ...
            case 45:
              if (((s += String.fromCharCode(e)), ++a === o || !m(i.charCodeAt(a)))) return (u = 16);
            case 48:
            case 49:
            case 50:
            case 51:
  ...
  (function(e) {
    ...
    (t.format = function(n, e, t) {
      ...
      var v = [];
      function y(e, t, r) {
        !h && t < s && a < r && n.substring(t, r) !== e && v.push({ offset: t, length: r - t, content: e });
      }
      var b = g();
      if (17 !== b) {
          ...
          case 1:
            return (function() {
              ...
              for (var e = !1; 2 !== o.getToken() && 17 !== o.getToken(); ) {
                ...
                (10 !== o.getToken()
                  ? (y(3, [], [2, 5]), 0)
                  : (b(!1), 6 === o.getToken() ? (d(':'), v(), x() || y(4, [], [2, 5])) : y(5, [], [2, 5]), 1)) ||
                  y(4, [], [2, 5]),
                  (e = !0);
              }
  ...
  (function(e) {
    ...
    function n(e, t, r, n, o) {
      for (
        ...
        0 < a.length && ((u = a.pop()), void 0 === (c = S.findNodeAtLocation(s, a)) && void 0 !== r);
      ...
      if (c) {
        if ('object' === c.type && 'string' == typeof u && Array.isArray(c.children)) {
          ...
          if (void 0 !== f) {
            if (void 0 !== r) return C(e, { offset: f.offset, length: f.length, content: JSON.stringify(r) }, n);
        ...
        if ('array' === c.type && 'number' == typeof u && Array.isArray(c.children)) {
          if (-1 === u) {
            ...
            else g = { offset: (b = c.children[c.children.length - 1]).offset + b.length, length: 0, content: ',' + h };
            return C(e, g, n);
          }
          if (void 0 === r && 0 <= c.children.length) {
            var v = u,
              y = c.children[v];
            g = void 0;
            if (1 === c.children.length) g = { offset: c.offset + 1, length: c.length - 2, content: '' };
            else if (c.children.length - 1 === v) {
              var b,
                x = (b = c.children[v - 1]).offset + b.length;
              g = { offset: x, length: c.offset + c.length - 2 - x, content: '' };
            } else g = { offset: y.offset, length: c.children[v + 1].offset - y.offset, content: '' };
            return C(e, g, n);
          }
      ...
      return C(e, { offset: s ? s.offset : 0, length: s ? s.length : 0, content: JSON.stringify(r) }, n);
    }
    function C(e, t, r) {
      var n = f(e, t),
        o = t.offset,
  ...
  (function(e) {
    ...
    (t.Range = o.Range),
      ...
      ((t.ClientCapabilities || (t.ClientCapabilities = {})).LATEST = {
        textDocument: {
          completion: { completionItem: { documentationFormat: [o.MarkupKind.Markdown, o.MarkupKind.PlainText] } },
        },
      });
  }),
      ...
      return (
        ...
        (r.prototype.with = function(e) {
          ...
          return (
            ...
            t === this.scheme && r === this.authority && n === this.path && o === this.query && i === this.fragment
              ? this
              : new f(t, r, n, o, i)
          );
        }),
  ...
  function g(e, t) {
    ...
    if (a) {
      if (3 <= a.length && 47 === a.charCodeAt(0) && 58 === a.charCodeAt(2))
        65 <= (l = a.charCodeAt(1)) && l <= 90 && (a = '/' + String.fromCharCode(l + 32) + ':' + a.substr(3));
...
!(function(e) {
          ...
          !(function(e, t, r, n) {
              ...
              for (var f = 0, l = t.required; f < l.length; f++) {
                ...
                if (!o[d]) {
                  var p = e.parent && 'property' === e.parent.type && e.parent.keyNode,
                    h = p ? { offset: p.offset, length: p.length } : { offset: e.offset, length: 1 };
                  r.problems.push({
                    location: h,
                  ...
                  if (W.isBoolean(y))
                    if (y) r.propertiesMatches++, r.propertiesValueMatches++;
                      ...
                      r.problems.push({
                        ...
                        severity: K.DiagnosticSeverity.Warning,
                        message: t.errorMessage || U('DisallowedExtraPropWarning', 'Property {0} is not allowed.', d),
                      });
                    }
                  else {
                    var x = new H();
                      ...
                      if (W.isBoolean(y))
                        if (y) r.propertiesMatches++, r.propertiesValueMatches++;
                          ...
                          r.problems.push({
                            ...
                            severity: K.DiagnosticSeverity.Warning,
                            message:
                              t.errorMessage || U('DisallowedExtraPropWarning', 'Property {0} is not allowed.', d),
                          });
                        }
                      else {
                        var x = new H();
            ...
            W.isNumber(t.maxProperties) &&
              ...
              r.problems.push({
                ...
                severity: K.DiagnosticSeverity.Warning,
                message: U('MaxPropWarning', 'Object has more properties than limit of {0}.', t.maxProperties),
              });
          ...
          !(function(e, t, r, n) {
            if (Array.isArray(t.items)) {
              for (var o = t.items, i = 0; i < o.length; i++) {
                var a = o[i],
                  ...
                  c = new H(),
                  u = e.items[i];
                u ? (z(u, s, c, n), r.mergePropertyMatch(c)) : e.items.length >= o.length && r.propertiesValueMatches++;
              }
            ...
            if (h) {
              ...
              m ||
                r.problems.push({
                  location: { offset: e.offset, length: e.length },
                  severity: K.DiagnosticSeverity.Warning,
                  message: t.errorMessage || U('requiredItemMissingWarning', 'Array does not contain required item.'),
                });
            }
            W.isNumber(t.minItems) &&
              ...
              r.problems.push({
                location: { offset: e.offset, length: e.length },
                severity: K.DiagnosticSeverity.Warning,
                message: U('minItemsWarning', 'Array has too few items. Expected {0} or more.', t.minItems),
              });
            W.isNumber(t.maxItems) &&
              ...
              r.problems.push({
                location: { offset: e.offset, length: e.length },
                severity: K.DiagnosticSeverity.Warning,
                message: U('maxItemsWarning', 'Array has too many items. Expected {0} or fewer.', t.maxItems),
              });
            if (!0 === t.uniqueItems) {
              var g = I(e),
          ...
          !(function(e, t, r, n) {
            W.isNumber(t.minLength) &&
              ...
              r.problems.push({
                location: { offset: e.offset, length: e.length },
                severity: K.DiagnosticSeverity.Warning,
                message: U('minLengthWarning', 'String is shorter than the minimum length of {0}.', t.minLength),
              });
            W.isNumber(t.maxLength) &&
              ...
              r.problems.push({
                location: { offset: e.offset, length: e.length },
                severity: K.DiagnosticSeverity.Warning,
                message: U('maxLengthWarning', 'String is longer than the maximum length of {0}.', t.maxLength),
              });
                ...
                case 'uri-reference':
                  ...
                  if (e.value)
                    try {
                      ...
                      a.scheme || 'uri' !== t.format || (i = U('uriSchemeMissing', 'URI with a scheme is expected.'));
                    } catch (e) {
                      i = e.message;
                    }
                  ...
                  i &&
                    r.problems.push({
                      ...
                      severity: K.DiagnosticSeverity.Warning,
                      message:
                        t.patternErrorMessage || t.errorMessage || U('uriFormatWarning', 'String is not a URI: {0}', i),
                    });
                  break;
                case 'email':
                  e.value.match(u) ||
                  ...
                  e.value.match(c) ||
                    r.problems.push({
                      ...
                      message:
                        t.patternErrorMessage ||
                        t.errorMessage ||
                        U('colorHexFormatWarning', 'Invalid color format. Use #RGB, #RGBA, #RRGGBB or #RRGGBBAA.'),
                    });
              }
          })(k, T, O);
          break;
          ...
          !(function(e, t, r, n) {
            ...
            W.isNumber(s) &&
              ...
              r.problems.push({
                location: { offset: e.offset, length: e.length },
                severity: K.DiagnosticSeverity.Warning,
                message: U('exclusiveMinimumWarning', 'Value is below the exclusive minimum of {0}.', s),
              });
            ...
            W.isNumber(c) &&
              ...
              r.problems.push({
                location: { offset: e.offset, length: e.length },
                severity: K.DiagnosticSeverity.Warning,
                message: U('exclusiveMaximumWarning', 'Value is above the exclusive maximum of {0}.', c),
              });
        ...
        Array.isArray(T.type)
          ? T.type.some(e) ||
            O.problems.push({
              ...
              message:
                T.errorMessage ||
                U('typeArrayMismatchWarning', 'Incorrect type. Expected one of {0}.', T.type.join(', ')),
            })
          : T.type &&
            (e(T.type) ||
              O.problems.push({
                location: { offset: k.offset, length: k.length },
                severity: K.DiagnosticSeverity.Warning,
                message: T.errorMessage || U('typeMismatchWarning', 'Incorrect type. Expected "{0}".', T.type),
              }));
        ...
        if (W.isDefined(T.const)) {
          ...
          W.equals(b, T.const)
            ...
            : (O.problems.push({
                ...
                severity: K.DiagnosticSeverity.Warning,
                code: E.ErrorCode.EnumValueMismatch,
                message: T.errorMessage || U('constWarning', 'Value must be {0}.', JSON.stringify(T.const)),
              }),
              (O.enumValueMatch = !1)),
    ...
    (t.parse = function(s, e) {
      ...
      function r() {
        switch (f.getTokenError()) {
          case 4:
            return p(U('InvalidUnicode', 'Invalid unicode sequence in string.'), E.ErrorCode.InvalidUnicode), !0;
          case 5:
            return (
              p(U('InvalidEscapeCharacter', 'Invalid escape character in string.'), E.ErrorCode.InvalidEscapeCharacter),
              !0
            );
          case 3:
            return p(U('UnexpectedEndOfNumber', 'Unexpected end of number.'), E.ErrorCode.UnexpectedEndOfNumber), !0;
          case 1:
            return p(U('UnexpectedEndOfComment', 'Unexpected end of comment.'), E.ErrorCode.UnexpectedEndOfComment), !0;
          case 2:
            return p(U('UnexpectedEndOfString', 'Unexpected end of string.'), E.ErrorCode.UnexpectedEndOfString), !0;
          case 6:
            return (
              p(
                U('InvalidCharacter', 'Invalid characters in string. Control characters must be escaped.'),
      ...
      function m(e, t) {
        ...
        if (
          ...
          10 === f.getToken() && s.positionAt(n.offset + n.length).line < s.positionAt(f.getTokenOffset()).line)
        )
        ...
        return (
          (function(e) {
            ...
            for (var r = !1; 4 !== f.getToken() && 17 !== f.getToken(); ) {
              ...
              o
                ? t.items.push(o)
                : p(U('PropertyExpected', 'Value expected'), E.ErrorCode.ValueExpected, null, [], [4, 5]),
                (r = !0);
            }
            return 4 !== f.getToken()
              ? p(
          ...
          (function(e) {
            ...
            for (var n = !1; 2 !== f.getToken() && 17 !== f.getToken(); ) {
              ...
              i
                ? t.properties.push(i)
                : p(U('PropertyExpected', 'Property expected'), E.ErrorCode.PropertyExpected, null, [], [2, 5]),
                (n = !0);
            }
            return 2 !== f.getToken()
              ? p(U('ExpectedCloseBrace', 'Expected comma or closing brace'), E.ErrorCode.CommaOrCloseBraceExpected, t)
              : h(t, !0);
          })(e) ||
          g(e) ||
          (function(e) {
            ...
            if (0 === f.getTokenError()) {
              ...
              try {
                var n = JSON.parse(r);
                if (!W.isNumber(n))
                  return p(U('InvalidNumberFormat', 'Invalid number format.'), E.ErrorCode.Undefined, t);
                t.value = n;
              } catch (e) {
                return p(U('InvalidNumberFormat', 'Invalid number format.'), E.ErrorCode.Undefined, t);
              }
      ...
      return (
        17 !== l() &&
          ((n = v(null))
            ? 17 !== f.getToken() && p(U('End of file expected', 'End of file expected.'), E.ErrorCode.Undefined)
            : p(U('Invalid symbol', 'Expected a JSON object, array or literal.'), E.ErrorCode.Undefined)),
        new k(n, a, t)
      );
    });
}),
              ...
              y = {
                add: function(e) {
                  ...
                  t
                    ...
                    : ((v[e.label] = e), g && (e.textEdit = x.TextEdit.replace(g, e.insertText)), d.items.push(e));
                },
            ...
            return this.schemaService.getSchemaForResource(u.uri, f).then(function(e) {
              ...
              if (h && 'object' === h.type) {
                ...
                n && (a = l.evaluateSeparatorAfter(u, u.offsetAt(g.end))),
                  e ? l.getPropertyCompletions(e, f, h, n, a, y) : l.getSchemaLessPropertyCompletions(f, h, t, y);
              ...
              var c = {};
              return (
                e ? l.getValueCompletions(e, f, h, p, u, y, c) : l.getSchemaLessValueCompletions(f, h, p, u, y),
                ...
                l.promiseConstructor.all(r).then(function() {
                  if (0 === y.getNumberOfProposals()) {
                    var e = p;
                    !h ||
                      ('string' !== h.type && 'number' !== h.type && 'boolean' !== h.type && 'null' !== h.type) ||
                      (e = h.offset + h.length);
            ...
            if (
              ...
              if (n && (null !== u || 'array' === n.type)) {
                ...
                t.getMatchingSchemas(e.schema, n.offset, f).forEach(function(e) {
                  ...
                  s.boolean && (this.addBooleanValueCompletion(!0, d, a), this.addBooleanValueCompletion(!1, d, a)),
            ...
            if (t) {
              ...
              if (
                (t.enum &&
                  ...
                  (s += t.enum.length)),
                g.isDefined(t.default) && (i || (i = this.getInsertTextForGuessedValue(t.default, '')), s++),
                0 === s)
              ) {
      ...
      r = (function() {
        ...
        return (
          (e.prototype.doHover = function(e, t, s) {
            ...
            if (!c || (('object' === c.type || 'array' === c.type) && r > c.offset + 1 && r < c.offset + c.length - 1))
    ...
    var c = (function() {
      ...
      return (
        ...
        (e.prototype.getOrAddFilePatternAssociation = function(e) {
          ...
          return (
            t || ((t = new r(e)), (this.filePatternAssociationById[e] = t), this.filePatternAssociations.push(t)), t
          );
        }),
        ...
        (e.prototype.clearExternalSchemas = function() {
          ...
          for (var t in this.contributionAssociations)
            for (
              var r = this.getOrAddFilePatternAssociation(t), n = 0, o = this.contributionAssociations[t];
              n < o.length;
              n++
            ) {
              var i = o[n];
        ...
        (e.prototype.loadSchema = function(i) {
          if (this.requestService)
            return this.requestService(i).then(
              function(e) {
                if (!e) {
                  var t = m('json.schema.nocontent', "Unable to load schema from '{0}': No content.", u(i));
                  return new s({}, [t]);
                }
                var r,
                  n = [];
        ...
        (e.prototype.resolveSchemaContent = function(e, t, r) {
          var u = this,
            ...
            f = function(e, t, r, n) {
              ...
              else s.push(m('json.schema.invalidref', "$ref '{0}' in '{1}' can not be resolved.", n, r));
            },
            l = function(r, n, o, e, i) {
              c && !/^\w+:\/\/.*/.test(n) && (n = c.resolveRelativePath(n, e)), (n = u.normalizeId(n));
              var a = u.getOrAddSchemaHandle(n);
              return a.getUnresolvedSchema().then(function(e) {
                if (((i[n] = !0), e.errors.length)) {
                  var t = o ? n + '#' + o : n;
                  s.push(m('json.schema.problemloadingref', "Problems loading reference '{0}': {1}", t, e.errors[0]));
                }
                ...
                var c = [e],
                  ...
                  r = function(e) {
                    for (var t = []; e.$ref; ) {
                      var r = e.$ref,
                        n = r.split('#', 2);
                      if ((delete e.$ref, 0 < n[0].length)) return void s.push(l(e, n[0], n[1], i, a));
        ...
        return (
          ...
          (e.prototype.doValidation = function(d, p, h, e) {
                ...
                if (e) {
                  if (e.errors.length && p.root) {
                    ...
                    if (o && '$schema' === o.keyNode.value) {
                      var i = o.valueNode || o,
                        a = y.Range.create(d.positionAt(i.offset), d.positionAt(i.offset + i.length));
                      v(
                        y.Diagnostic.create(
                          a,
                          e.errors[0],
            ...
            if (e) {
              ...
              return this.jsonSchemaService.resolveSchemaContent(new o.UnresolvedSchema(e), n, {}).then(function(e) {
                return t(e);
              });
            }
      ...
      r = (function() {
        ...
        return (
                    ...
                    for (var t = 0, r = e.properties; t < r.length; t++) {
                      ...
                      if ('key' === n.keyNode.value && n.valueNode) {
                        if (n.valueNode) {
                          ...
                          i.push({ name: l.getNodeValue(n.valueNode), kind: f.SymbolKind.Function, location: o });
                        }
                        return;
                      }
                    }
                  ...
                  ? e.items.forEach(function(e, t) {
                      if (e) {
                        var r = p(s, e),
                          ...
                          o = String(t),
                          i = u([], e);
                        a.push({ name: o, kind: c.getSymbolKind(e.type), range: r, selectionRange: n, children: i });
                      }
                    })
                  : 'object' === e.type &&
                    e.properties.forEach(function(e) {
          ...
          (e.prototype.getColorPresentations = function(e, t, r, n) {
            ...
            return (
              (o = 1 === r.alpha ? '#' + u(a) + u(s) + u(c) : '#' + u(a) + u(s) + u(c) + u(Math.round(255 * r.alpha))),
  ...
  (function(e) {
    ...
    var n = {
      ...
      maxItems: r('schema.json.maxItems', 'The maximum number of items that can be inside an array. Inclusive.'),
      minItems: r('schema.json.minItems', 'The minimum number of items that can be inside an array. Inclusive.'),
      uniqueItems: r('schema.json.uniqueItems', 'If all of the items in the array must be unique. Defaults to false.'),
      maxProperties: r('schema.json.maxProperties', 'The maximum number of properties an object can have. Inclusive.'),
      minProperties: r('schema.json.minProperties', 'The minimum number of properties an object can have. Inclusive.'),
      required: r(
      ...
      properties: r('schema.json.properties', 'A map of property names to schemas for each property.'),
      patternProperties: r(
      ...
      $comment: r('schema.json.$comment', 'Comments from schema authors to readers or maintainers of the schema.'),
      readOnly: r(
      ...
      contentMediaType: r('schema.json.contentMediaType', 'Describes the media type of a string property.'),
      contentEncoding: r('schema.json.contentEncoding', 'Describes the content encoding of a string property.'),
      if: r(
        'schema.json.if',
        'The validation outcome of the "if" subschema controls which of the "then" or "else" keywords are evaluated.',
      ),
      then: r('schema.json.then', 'The "if" subschema is used for validation when the "if" subschema succeeds.'),
      else: r('schema.json.else', 'The "else" subschema is used for validation when the "if" subschema fails.'),
    };
        ...
        switch (s) {
          ...
          case 13:
            ...
            1 === a.getTokenError() && d + 1 < e.lineCount
              ...
              : d < p && (c({ startLine: d, endLine: p, kind: A.FoldingRangeKind.Comment }), (i = d));
            break;
          case 12:
            var h = e
              .getText()
            ...
            if (h)
              if (((l = e.positionAt(a.getTokenOffset()).line), h[1]))
                ...
                0 <= m &&
                  ((u = o[m]),
                  (o.length = m),
                  l > u.startLine && i !== u.startLine && ((u.endLine = l), c(u), (i = u.startLine)));
              }
        }
        s = a.scan();
      }
  ...
  (function(e) {
    ...
    t.getSelectionRanges = function(u, e, f) {
      function l(e, t) {
        return { range: r.Range.create(u.positionAt(e), u.positionAt(t)), kind: o.SelectionRangeKind.Declaration };
      }
        ...
        for (var i = []; o; ) {
          switch (o.type) {
            ...
            case 'array':
              ...
              a < s && a <= n && n <= s && i.push(l(a, s)), i.push(l(o.offset, o.offset + o.length));
              break;
            case 'number':
            case 'boolean':
            case 'null':
