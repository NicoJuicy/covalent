    ...
    return (
      ...
      (n.prototype.moduleIdToPaths = function(t) {
        ...
        if (e.Utilities.endsWith(o, '.js') || e.Utilities.isAbsolutePath(o))
          e.Utilities.endsWith(o, '.js') || e.Utilities.containsQueryString(o) || (o += '.js'), (n = [o]);
        else
          for (var r = 0, i = (n = this._applyPaths(o)).length; r < i; r++)
            (this.isBuild() && 'empty:' === n[r]) ||
              ...
              e.Utilities.endsWith(n[r], '.js') || e.Utilities.containsQueryString(n[r]) || (n[r] = n[r] + '.js'));
  ...
  var t = (function() {
      ...
      return (
        (e.prototype.load = function(e, t, i, s) {
          var a = this;
          this._scriptLoader ||
            (this._scriptLoader = this._env.isWebWorker ? new o() : this._env.isNode ? new r(this._env) : new n());
    ...
    r = (function() {
      function t(e) {
        (this._env = e), (this._didInitialize = !1), (this._didPatchNodeRequire = !1), (this._hasCreateCachedData = !1);
      }
      return (
            ...
            (o = e.Utilities.fileUriToFilePath(this._env.isWindows, o)),
              this._fs.readFile(o, { encoding: 'utf8' }, function(e, d) {
                if (e) i(e);
                  ...
                  if (
                    ((p = d.charCodeAt(0) === t._BOM ? _ + d.substring(1) + '\n});' : _ + d + '\n});'),
                    (p = u(p, c)),
                    a.nodeCachedData)
                  ) {
  ...
  var s = (function() {
    ...
    return (
      ...
      (s.prototype._onLoadError = function(e, t) {
        for (
          var n = this._createLoadError(e, t), o = [], r = 0, i = this._moduleIdProvider.getMaxModuleId();
          r < i;
          r++
        )
          o[r] = !1;
...
!(function(e) {
  ...
  (s.config = i),
    ...
    ('function' == typeof e.global.define && e.global.define.amd) ||
      ((o = new e.ModuleManager(n, e.createScriptLoader(n), r, s, e.Utilities.getHighPerformanceTimestamp())),
