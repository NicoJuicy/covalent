...
define('vs/editor/editor.main.nls.zh-cn', {
  ...
  'vs/editor/contrib/cursorUndo/cursorUndo': ['软撤消'],
  ...
  'vs/editor/contrib/hover/modesContentHover': ['正在加载...', '快速修复...', '速览问题', '没有可用的代码操作'],
  ...
  'vs/editor/contrib/referenceSearch/referenceSearch': [' – {0} 个引用', '查看引用'],
  ...
  'vs/editor/contrib/referenceSearch/referencesTree': ['解析文件失败。', '{0} 个引用', '{0} 个引用'],
