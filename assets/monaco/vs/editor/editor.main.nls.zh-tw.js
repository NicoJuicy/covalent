...
define('vs/editor/editor.main.nls.zh-tw', {
  ...
  'vs/editor/contrib/cursorUndo/cursorUndo': ['軟復原'],
  ...
  'vs/editor/contrib/hover/modesContentHover': ['正在載入...', '快速修復...', '瞄孔問題', '沒有可用的程式碼操作'],
  ...
  'vs/editor/contrib/referenceSearch/referenceSearch': [' - {0} 個參考', '預覽參考'],
  ...
  'vs/editor/contrib/referenceSearch/referencesTree': ['無法解析檔案。', '{0} 個參考', '{0} 個參考'],
