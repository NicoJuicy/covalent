              ...
              for (
                ...
                if (!isNaN(M)) {
                  ...
                  if ((_ && (l[a][I] || (l[a][I] = { p: b, n: b }), (C = l[a][I][L])), 'radius' === p.dim)) {
                    ...
                    var R = p.dataToAngle(M, !0) - b,
                      E = n.dataToRadius(I);
                    Math.abs(R) < v && (R = (R < 0 ? -1 : 1) * v),
                      (D = (A = E + h) + d),
                      (T = C),
                      (P = C + R),
                      _ && (l[a][I][L] = P);
      ...
      let r = (() => {
        ...
        return (
          ...
          (e.ɵcmp = n.Mb({
            ...
            features: [n.Cb([{ provide: a.c, useExisting: Object(n.V)(() => e) }]), n.Ab],
            attrs: o,
            decls: 0,
            vars: 0,
        ...
        d = o.extend({
          ...
          _renderTicks: function(e, t, i, n, o, r, c, h) {
            for (
              ...
              if (_.get('show')) {
                var R = u(l((L / b) * (v - m) + m), _.get('formatter')),
                  E = _.get('distance'),
                  O = n(L / b);
                d.add(
                  new a.Text({
      ...
      if (!n.canvasSupported) {
          ...
          this.__dirtyPath &&
            ...
            (i.path = (function(e, t) {
              ...
              for (r = 0; r < m; ) {
                switch (((n = ''), (i = 0), (o = f[r++]))) {
                  case c:
                    (n = ' m '), (i = 1), (s = f[r++]), (l = f[r++]), (R[0][0] = s), (R[0][1] = l);
                    break;
                  case h:
                    (n = ' l '), (i = 1), (s = f[r++]), (l = f[r++]), (R[0][0] = s), (R[0][1] = l);
                    break;
                  case p:
                  case u:
                    (n = ' c '), (i = 3);
                ...
                if (i > 0) {
                  ...
                  for (var j = 0; j < i; j++) {
                    var q = R[j];
                    t && a(q, q, t), g.push(y(q[0] * M - I), ',', y(q[1] * M - I), j < i - 1 ? ',' : '');
                  }
                }
              }
              return g.join('');
            ...
            if (r) {
              ...
              if (
                ...
                var z = [h, d],
                  ...
                  E = [h, d + g],
                  O = [h + p, d + g];
                a(z, z, I), a(R, R, I), a(E, E, I), a(O, O, I);
                var V = w(z[0], R[0], E[0], O[0]),
                  N = w(z[1], R[1], E[1], O[1]),
                  G = [];
                G.push(
                  'M11=',
        ...
        s.$override('measureText', function(e, t) {
          ...
          E ||
            ...
            m.doc.body.appendChild(E));
          try {
            E.style.font = t;
          } catch (n) {}
          return (E.innerHTML = ''), E.appendChild(i.createTextNode(e)), { width: E.offsetWidth };
        });
        for (
          var G = new o(),
            B = function(e, t, i, n) {
              ...
              if ((null != r && (r += ''), r)) {
                ...
                var D,
                  ...
                  E = this._textVmlEl;
                E
                  ? (P = (D = (k = E.firstChild).nextSibling).nextSibling)
                  : ((E = R('line')),
                    (D = R('path')),
                    (P = R('textpath')),
                    (k = R('skew')),
                ...
                z(E, 'fill', { fill: o.textFill, opacity: o.opacity }, this),
                  z(E, 'stroke', { stroke: o.textStroke, opacity: o.opacity, lineDash: o.lineDash }, this),
                  (E.style.zIndex = L(this.zlevel, this.z, this.z2)),
                  T(e, E);
              }
            },
            Y = function(e) {
    ...
    'y3NT': function(e, t, i) {
      ...
      e.exports = function(e, t, i, r) {
        t.eachSeriesByType(e, function(e) {
              ...
              if (e) {
                ...
                if (e !== m) {
                  var o = e.getValue(),
                    r = 0 === b && A ? S : o * S;
                  r < f && (r = f), (i = t + D * r);
                  var s = e.depth - y - (w ? -1 : 1),
                    l = d + M * s,
                    p = d + M * (s + 1),
                    g = e.getModel();
                  null != g.get('r0') && (l = n(g.get('r0'), c / 2)),
                    null != g.get('r') && (p = n(g.get('r'), c / 2)),
                    e.setLayout({ angle: r, startAngle: t, endAngle: i, clockwise: I, cx: u, cy: h, r0: l, r: p });
                }
          ...
          if (w) {
            var P = 2 * Math.PI;
            m.setLayout({ angle: P, startAngle: g, endAngle: g + P, clockwise: I, cx: u, cy: h, r0: d, r: d + M });
          }
          T(v, g);
        });
      };
            ...
            template: function(e, t) {
              1 & e &&
                ...
                2 & e &&
                  ...
                  )('roam', !0)('itemStyle', o.vc(116, he, o.vc(114, ue, o.uc(113, ce)))));
            },
