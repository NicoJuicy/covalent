    ...
    'Ck+y': function(t, e, a) {
      ...
      o.registerLayout(function(t, e) {
        t.eachSeriesByType('wordCloud', function(a) {
          var r = n.getLayoutRect(a.getBoxLayoutParams(), { width: e.getWidth(), height: e.getHeight() }),
            s = a.getData(),
          ...
          if (c)
            try {
              l.drawImage(c, 0, 0, d.width, d.height),
                (function(t) {
                  for (
                    var e = t.getContext('2d'),
                      a = e.getImageData(0, 0, t.width, t.height),
                      o = e.createImageData(a),
                      n = 0,
                      i = 0,
                      r = 0;
                    r < a.data.length;
                    ...
                    a.data[r + 3] > 128 && ((n += d = a.data[r] + a.data[r + 1] + a.data[r + 2]), ++i);
                  var s = n / i;
                  for (r = 0; r < a.data.length; r += 4) {
                    var d = a.data[r] + a.data[r + 1] + a.data[r + 2];
                    a.data[r + 3] < 128 || d > s
                      ? ((o.data[r] = 0), (o.data[r + 1] = 0), (o.data[r + 2] = 0), (o.data[r + 3] = 0))
                      : ((o.data[r] = 255), (o.data[r + 1] = 255), (o.data[r + 2] = 255), (o.data[r + 3] = 255));
                  }
          ...
          var h = a.get('sizeRange'),
            u = a.get('rotationRange'),
          ...
          function p(t) {
            ...
            t.detail.drawn &&
              ...
              ((t.detail.drawn.gx += r.x / g),
              (t.detail.drawn.gy += r.y / g),
          ...
          i(d, {
            list: s
              .mapArray('value', function(t, e) {
                ...
                return [s.getName(e), a.get('textStyle.normal.textSize', !0) || o.number.linearMap(t, f, h), e];
              })
              .sort(function(t, e) {
                return e[1] - t[1];
              }),
            ...
            d.addEventListener('wordclouddrawn', p),
            a.layoutInstance && a.layoutInstance.dispose(),
            (a.layoutInstance = {
              ondraw: null,
              dispose: function() {
                d.removeEventListener('wordclouddrawn', p),
                  d.addEventListener('wordclouddrawn', function(t) {
                    t.preventDefault();
                  });
              },
            });
        ...
        (i = (function() {
          if (n) {
            for (var t, e, a = document.createElement('canvas').getContext('2d'), o = 20; o; ) {
              if (
                ((a.font = o.toString(10) + 'px sans-serif'),
          ...
          if (n) {
            ...
            var M,
              ...
              C = function(t) {
                ...
                var i = a - n.top,
                  r = Math.floor(((e - n.left) * (o.width / n.width || 1)) / g),
                  s = Math.floor((i * (o.height / n.height || 1)) / g);
                return b[r][s];
              },
              T = function(t) {
                var e = C(t);
              ...
              R = function(t) {
                ...
                var e = 8 * t,
                  o = e,
                  n = [];
                for (0 === t && n.push([h[0], h[1], 0]); o--; ) {
                  var i = 1;
                  'circle' !== a.shape && (i = a.shape((o / e) * 2 * Math.PI)),
                    n.push([
                      h[0] + t * i * Math.cos((-o / e) * 2 * Math.PI),
                      h[1] + t * i * Math.sin((-o / e) * 2 * Math.PI) * a.ellipticity,
                      (o / e) * 2 * Math.PI,
                    ]);
                }
                return (E[t] = n), n;
              ...
              k = function() {
                return a.abortThreshold > 0 && new Date().getTime() - f > a.abortThreshold;
              },
              O = function(e, a, o, n, i) {
                e >= l ||
                  a >= c ||
                  e < 0 ||
                  a < 0 ||
                  ((d[e][a] = !1),
                  o && t[0].getContext('2d').fillRect(e * g, a * g, p, p),
                  S && (b[e][a] = { item: i, dimension: n }));
              },
              D = function(e, a, o) {
                if (a)
                  return !t.some(function(t) {
                    var n = document.createEvent('CustomEvent');
                    return n.initCustomEvent(e, !0, a, o || {}), !t.dispatchEvent(n);
                  }, this);
                t.forEach(function(t) {
                  var n = document.createEvent('CustomEvent');
                  n.initCustomEvent(e, !0, a, o || {}), t.dispatchEvent(n);
                }, this);
              };
            !(function() {
              var e = t[0];
              if (e.getContext) (l = Math.ceil(e.width / g)), (c = Math.ceil(e.height / g));
              else {
                var o = e.getBoundingClientRect();
                (l = Math.ceil(o.width / g)), (c = Math.ceil(o.height / g));
              }
              if (D('wordcloudstart', !0)) {
                var n, s, p, C, E;
                if (
                  ((h = a.origin ? [a.origin[0] / g, a.origin[1] / g] : [l / 2, c / 2]),
                  (u = Math.floor(Math.sqrt(l * l + c * c))),
                  (d = []),
                  ...
                  for (
                    t.forEach(function(t) {
                      if (t.getContext) {
                        ...
                        (e.fillStyle = a.backgroundColor),
                          e.clearRect(0, 0, l * (g + 1), c * (g + 1)),
                          e.fillRect(0, 0, l * (g + 1), c * (g + 1));
                    ...
                    for (d[n] = [], s = c; s--; ) d[n][s] = !0;
                else {
                  var z = document.createElement('canvas').getContext('2d');
                  (z.fillStyle = a.backgroundColor), z.fillRect(0, 0, 1, 1);
                  var P,
                    L,
                    W = z.getImageData(0, 0, 1, 1).data,
                    F = e.getContext('2d').getImageData(0, 0, l * g, c * g).data;
                  for (n = l; n--; )
                    for (d[n] = [], s = c; s--; ) {
                      L = g;
                      t: for (; L--; )
                ...
                (p = 0),
                  0 !== a.wait
                    ? ((C = window.setTimeout), (E = window.clearTimeout))
                    : ((C = window.setImmediate), (E = window.clearImmediate));
                var A = function(e, a) {
                    t.forEach(function(t) {
                ...
                var X = C(function e() {
                  if (p >= a.list.length) return E(X), D('wordcloudstop', !1), void A('wordcloudstart', B);
                  f = new Date().getTime();
                  var o = (function(e) {
                      var o, n, s;
                      Array.isArray(e) ? ((o = e[0]), (n = e[1])) : ((o = e.word), (n = e.weight), (s = e.attributes));
                      var h,
                        f,
                        p,
                        M =
                        ...
                        b = (function(t, e, o) {
                          var n = a.weightFactor(e);
                          if (n <= a.minSize) return !1;
                          var r = 1;
                          n < i &&
                            (r = (function() {
                              for (var t = 2; t * n < i; ) t += 2;
                              return t;
                            })());
                          var s = document.createElement('canvas'),
                            d = s.getContext('2d', { willReadFrequently: !0 });
                          d.font = a.fontWeight + ' ' + (n * r).toString(10) + 'px ' + a.fontFamily;
                          var l = d.measureText(t).width / r,
                            c = Math.max(n * r, d.measureText('m').width, d.measureText('\uff37').width) / r,
                            h = l + 2 * c,
                            u = 3 * c,
                            f = Math.ceil(h / g),
                            m = Math.ceil(u / g);
                          ...
                          var p = -l / 2,
                            w = 0.4 * -c,
                            v = Math.ceil((h * Math.abs(Math.sin(o)) + u * Math.abs(Math.cos(o))) / g),
                            y = Math.ceil((h * Math.abs(Math.cos(o)) + u * Math.abs(Math.sin(o))) / g),
                            x = y * g,
                            M = v * g;
                          s.setAttribute('width', x),
                            s.setAttribute('height', M),
                            d.scale(1 / r, 1 / r),
                            d.translate((x * r) / 2, (M * r) / 2),
                            d.rotate(-o),
                            (d.font = a.fontWeight + ' ' + (n * r).toString(10) + 'px ' + a.fontFamily),
                            (d.fillStyle = '#000'),
                            (d.textBaseline = 'middle'),
                            d.fillText(t, p * r, (w + 0.5 * n) * r);
                          var S = d.getImageData(0, 0, x, M).data;
                          if (k()) return !1;
                          for (var b, C, T, I = [], E = y, R = [v / 2, y / 2, v / 2, y / 2]; E--; )
                            for (b = v; b--; ) {
                              T = g;
                              t: for (; T--; )
                                for (C = g; C--; )
                                  if (S[4 * ((b * g + T) * x + (E * g + C)) + 3]) {
                                    I.push([E, b]),
                                      E < R[3] && (R[3] = E),
                                      E > R[1] && (R[1] = E),
                                      b < R[0] && (R[0] = b),
                      ...
                      if (!a.drawOutOfBound) {
                        var C = b.bounds;
                        if (C[1] - C[3] + 1 > l || C[2] - C[0] + 1 > c) return !1;
                      }
                      for (var T = u + 1; T--; ) {
                        var I = R(u - T);
                        a.shuffle && ((I = [].concat(I)), r(I));
                          ...
                          var D =
                            ...
                            !!(function(t, e, o, n, i) {
                              for (var r = i.length; r--; ) {
                                ...
                                } else if (!d[s][h]) return !1;
                              }
                              return !0;
                            })(
                              (f = Math.floor(h[0] - b.gw / 2)),
                              (p = Math.floor(h[1] - b.gh / 2)),
                              0,
                              0,
                              b.occupied,
                            ) &&
                              ((function(e, o, n, i, r, s, d, l, c) {
                                var h,
                                  u,
                                  f = n.fontSize;
                                (h = m ? m(i, r, f, s, d) : a.color),
                                  (u = x ? x(i, r, f, s, d) : a.classes),
                                  t.forEach(function(t) {
                                    if (t.getContext) {
                                      ...
                                      r.save(),
                                        r.scale(1 / s, 1 / s),
                                        (r.font = a.fontWeight + ' ' + (f * s).toString(10) + 'px ' + a.fontFamily),
                                        (r.fillStyle = h),
                                        r.translate((e + n.gw / 2) * g * s, (o + n.gh / 2) * g * s),
                                        0 !== l && r.rotate(-l),
                                        (r.textBaseline = 'middle'),
                                        r.fillText(i, n.fillTextOffsetX * s, (n.fillTextOffsetY + 0.5 * f) * s),
                                        r.restore();
                                    } else {
                                      ...
                                      (m = 'rotate(' + (-l / Math.PI) * 180 + 'deg) '),
                                        1 !== n.mu &&
                                          (m += 'translateX(-' + n.fillTextWidth / 4 + 'px) scale(' + 1 / n.mu + ')');
                                      var p = {
                                        position: 'absolute',
                                        display: 'block',
                                        font: a.fontWeight + ' ' + f * n.mu + 'px ' + a.fontFamily,
                                        left: (e + n.gw / 2) * g + n.fillTextOffsetX + 'px',
                                        top: (o + n.gh / 2) * g + n.fillTextOffsetY + 'px',
                                      ...
                                      for (var w in (h && (p.color = h), (d.textContent = i), p)) d.style[w] = p[w];
                                      if (c) for (var v in c) d.setAttribute(v, c[v]);
                                      u && (d.className += u), t.appendChild(d);
                                    }
                                  });
                              })(f, p, b, o, n, u - T, h[2], M, s),
                              (function(e, o, n, i, r, s) {
                                var d,
                                  h,
                                  u = r.occupied,
                                  f = a.drawMask;
                                if ((f && ((d = t[0].getContext('2d')).save(), (d.fillStyle = a.maskColor)), S)) {
                                  var m = r.bounds;
                                  h = {
                                    x: (e + m[3]) * g,
                                    y: (o + m[0]) * g,
                                ...
                                for (var p = u.length; p--; ) {
                                  var w = e + u[p][0],
                                    v = o + u[p][1];
                                  w >= l || v >= c || w < 0 || v < 0 || O(w, v, f, h, s);
                                }
                                f && d.restore();
                              })(f, p, 0, 0, b, e),
                              { gx: f, gy: p, rot: M, info: b }));
                          if (D) return D;
                        }
                      }
                      return null;
                    })(a.list[p]),
                    n = !D('wordclouddrawn', !0, { item: a.list[p], drawn: o });
                  if (k() || n)
                    return (
                      E(X), a.abort(), D('wordcloudabort', !1), D('wordcloudstop', !1), void A('wordcloudstart', B)
                    );
                  p++, (X = C(e, a.wait));
                }, a.wait);
              }
      ...
      let u = (() => {
        class t {
          ...
          randomColor() {
            return (
              'rgb(' +
              [Math.round(160 * Math.random()), Math.round(160 * Math.random()), Math.round(160 * Math.random())].join(
                ',',
              ) +
              ')'
            );
          }
          generateRandomWords(t) {
            return Array.apply(void 0, Array(30)).map(() => ({
        ...
        return (
          (t.ɵfac = function(e) {
            return new (e || t)(i.Sb(i.h), i.Sb(r.a));
          }),
          (t.ɵcmp = i.Mb({
            type: t,
            ...
            template: function(t, e) {
              1 & t &&
                ...
                i.Yb(1, 'td-chart'),
                i.Tc(2, '\n          '),
                i.Tb(3, 'td-chart-tooltip', 0),
                i.Tc(4, '\n          '),
                i.Yb(5, 'td-chart-series', 1),
                i.Tc(6, '\n          '),
                i.Wb(),
                i.Tc(7, '\n        '),
                i.Wb()),
                2 & t &&
                  ...
                  i.qc('trigger', 'item'),
                  i.Db(2),
                  i.qc('sizeRange', i.uc(6, c))('rotationRange', i.vc(7, h, -30))('color', e.randomColor)(
                    'data',
                    e.componentExampleRandomWords,
                  ));
            },
            directives: [s.a, d.a, l.a],
      ...
      o.extendChartView({
        ...
        render: function(t, e, a) {
          ...
          (t.layoutInstance.ondraw = function(t, e, a, s) {
            var d = i.getItemModel(a),
              l = d.getModel('textStyle.normal'),
              c = d.getModel('textStyle.emphasis'),
              h = new o.graphic.Text({
                style: o.graphic.setTextStyle({}, l, {
                ...
                position: [(s.gx + s.info.gw / 2) * r, (s.gy + s.info.gh / 2) * r],
                rotation: s.rot,
              });
            n.add(h),
              i.setItemGraphicEl(a, h),
              o.graphic.setHoverStyle(h, o.graphic.setTextStyle({}, c, null, { forMerge: !0 }, !0));
          }),
            (this._model = t);
        },
        remove: function() {
